...
public:
  ...
  virtual void Load() override {
    ...
    Nexus::Graphics::HdriProcessor processor(
        "resources/demo/hdri/hangar_interior_4k.hdr", m_GraphicsDevice);
  ...
  virtual void Render(Nexus::Time time) override {
    ...
    auto indexCount =
        m_Cube->GetIndexBuffer()->GetDescription().Size / sizeof(unsigned int);
  ...
  void CreatePipeline() {
    ...
    pipelineDescription.VertexModule =
        m_GraphicsDevice->CreateShaderModuleFromSpirvFile(
            "resources/demo/shaders/cubemap.vert.glsl",
            Nexus::Graphics::ShaderStage::Vertex);
    pipelineDescription.FragmentModule =
        m_GraphicsDevice->CreateShaderModuleFromSpirvFile(
            "resources/demo/shaders/cubemap.frag.glsl",
