    ...
    class ComputeIndirectDemo : public Demo
    {
      public:
        ...
        virtual void Load() override
        {
            ...
            indirectDesc.SizeInBytes =
                sizeof(Nexus::Graphics::IndirectDispatchArguments);
            indirectDesc.StrideInBytes =
                sizeof(Nexus::Graphics::IndirectDispatchArguments);
        ...
        {
            return "Updating a texture using a Compute Pipeline and an indirect "
                   "buffer";
        }
