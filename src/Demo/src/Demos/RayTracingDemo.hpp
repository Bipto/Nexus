    ...
    class RayTracingDemo : public Demo
    {
      public:
        ...
        virtual void Load() override
        {
            ...
            Nexus::Graphics::AccelerationStructureProperties
            ...
            // set up buffers
            {
                ...
                vertexBufferDesc.Access =
                    Nexus::Graphics::BufferMemoryAccess::Default;
                vertexBufferDesc.Usage = Nexus::Graphics::
                    BufferUsage_AccelerationStructureBuildInputReadOnly;
                vertexBufferDesc.StrideInBytes =
                    sizeof(Nexus::Graphics::VertexPosition);
                ...
                m_VertexBuffer =
                    m_GraphicsDevice->CreateDeviceBuffer(vertexBufferDesc);
                ...
                indexBufferDesc.Access =
                    Nexus::Graphics::BufferMemoryAccess::Default;
                indexBufferDesc.Usage = Nexus::Graphics::
                    BufferUsage_AccelerationStructureBuildInputReadOnly;
                ...
                m_IndexBuffer =
                    m_GraphicsDevice->CreateDeviceBuffer(indexBufferDesc);
                Nexus::Utils::WriteToBuffer(
                    m_CommandQueue, m_IndexBuffer, indices.data(), 0,
            ...
            // BLAS
            {
                ...
                triangleDesc.VertexBufferFormat =
                    Nexus::Graphics::VertexFormat::R32G32B32_SFloat;
                triangleDesc.VertexBufferStride =
                    sizeof(Nexus::Graphics::VertexPosition);
                triangleDesc.VertexCount = 3;
                triangleDesc.IndexBuffer = m_IndexBuffer->GetDeviceAddress(0);
                triangleDesc.IndexBufferFormat =
                    Nexus::Graphics::IndexFormat::UInt32;
                triangleDesc.IndexCount = 3;
                triangleDesc.TransformBuffer = {};

                Nexus::Graphics::AccelerationStructureGeometryDescription
                    geometryDesc = {};
                geometryDesc.Type = Nexus::Graphics::GeometryType::Triangles;
                geometryDesc.Flags = 0;
                geometryDesc.Geometry = triangleDesc;

                Nexus::Graphics::AccelerationStructureGeometryBuildDescription
                    geometryBuildDesc = {};
                geometryBuildDesc.Type =
                    Nexus::Graphics::AccelerationStructureType::BottomLevel;
                geometryBuildDesc.Flags = 0;
                geometryBuildDesc.Geometry = {geometryDesc};
                geometryBuildDesc.Mode =
                    Nexus::Graphics::AccelerationStructureBuildMode::Build;
                geometryBuildDesc.Source = {};
                geometryBuildDesc.Destination = {};
                geometryBuildDesc.ScratchBuffer = {};

                Nexus::Graphics::AccelerationStructureBuildSizeDescription
                    buildSize = m_GraphicsDevice->GetAccelerationStructureBuildSize(
                        geometryBuildDesc
                    );
                ...
                accelerationBufferDesc.Access =
                    Nexus::Graphics::BufferMemoryAccess::Default;
                accelerationBufferDesc.DebugName = "BLAS Buffer";
                accelerationBufferDesc.SizeInBytes =
                    buildSize.AccelerationStructureSize;
                accelerationBufferDesc.StrideInBytes =
                    buildSize.AccelerationStructureSize;
                accelerationBufferDesc.Usage =
                    Nexus::Graphics::BufferUsage_AccelerationStructureStorage;
                m_BLASBuffer =
                    m_GraphicsDevice->CreateDeviceBuffer(accelerationBufferDesc);

                Nexus::Graphics::AccelerationStructureDescription
                    accelerationStructureDesc = {};
                accelerationStructureDesc.Size = buildSize.AccelerationStructureSize;
                accelerationStructureDesc.Type =
                    Nexus::Graphics::AccelerationStructureType::BottomLevel;
                accelerationStructureDesc.DebugName = "BLAS";
                accelerationStructureDesc.Buffer = m_BLASBuffer;
                accelerationStructureDesc.Offset = 0;
                m_BLAS = m_GraphicsDevice->CreateAccelerationStructure(
                    accelerationStructureDesc
                );
            ...
            // TLAS
            {
                ...
                instance.Flags = Nexus::Graphics::
                    AccelerationStructureGeometryInstanceFlags::ForceOpaque;
                instance.AccelerationStructureReference =
                    m_BLAS->GetDeviceAddress(0);
                instance.Mask = 0xFF;
                ...
                transformBufferDesc.Access =
                    Nexus::Graphics::BufferMemoryAccess::Default;
                transformBufferDesc.Usage = Nexus::Graphics::
                    BufferUsage_AccelerationStructureBuildInputReadOnly;
                transformBufferDesc.StrideInBytes =
                    sizeof(Nexus::Graphics::AccelerationStructureInstance);
                transformBufferDesc.SizeInBytes =
                    sizeof(Nexus::Graphics::AccelerationStructureInstance);
                m_TransformBuffer =
                    m_GraphicsDevice->CreateDeviceBuffer(transformBufferDesc);
                Nexus::Utils::WriteToBuffer(
                ...
                Nexus::Graphics::AccelerationStructureGeometryBuildDescription
                    geometryBuildDesc = {};
                geometryBuildDesc.Type =
                    Nexus::Graphics::AccelerationStructureType::TopLevel;
                geometryBuildDesc.Flags = 0;
                geometryBuildDesc.Geometry = {geometryDesc};
                ...
                accelerationStructureDesc.Offset = 0;
                m_TLAS = m_GraphicsDevice->CreateAccelerationStructure(
                    accelerationStructureDesc
                );
            ...
            // storage texture
            {
                ...
                m_StorageTextureView =
                    m_GraphicsDevice->CreateTextureView(textureViewDesc);

                m_BoundImGuiTextureID =
                    m_ImGuiRenderer->BindTexture(m_StorageTextureView);
            }
            ...
            // Pipeline
            {
                ...
                if (m_GraphicsDevice->GetGraphicsAPI().API ==
                    Nexus::Graphics::GraphicsAPI::Vulkan)
                {
                    ...
                    m_Pipeline =
                        m_GraphicsDevice->CreateRayTracingPipeline(pipelineDesc);
                    ...
                    storageImageView.Access =
                        Nexus::Graphics::ShaderAccess::ReadWrite;
                    storageImageView.ArrayLayer = 0;
                    storageImageView.MipLevel = 0;
                    m_ResourceSet->WriteStorageImage(
                        storageImageView, "outputImage"
                    );
                ...
                m_Pipeline->GetType() == Nexus::Graphics::PipelineType::RayTracing)
            {
                ...
                const uint32_t handleSize =
                    deviceRayTracingDesc.ShaderGroupHandleSize; // e.g., 32
                const uint32_t recordStride =
                    deviceRayTracingDesc.ShaderGroupBaseAlignment; // e.g., 32 or 64
                ...
                const Nexus::Graphics::IRayTracingPipeline *pipeline =
                    m_Pipeline
                        .AsDerived<const Nexus::Graphics::IRayTracingPipeline>();
                std::vector<uint8_t> handles =
                    pipeline
                        ->GetRayTracingShaderGroupHandles(); // size == groupCount *
                                                             // handleSize

                Nexus::Graphics::DeviceBufferDescription sbtDesc = {};
                sbtDesc.SizeInBytes = sbtSize;
                sbtDesc.StrideInBytes =
                    recordStride; // per-record stride, not sbtSize
                sbtDesc.Access = Nexus::Graphics::BufferMemoryAccess::Default;
                sbtDesc.Flags = Nexus::Graphics::BufferCreateFlags_None;
                sbtDesc.Usage =
                    Nexus::Graphics::BufferUsage::BufferUsage_ShaderBindingTable;
                ...
                Nexus::Utils::WriteToBuffer(
                    m_CommandQueue, m_SBT, sbtData.data(), 0, sbtData.size()
                );

                // Regions
                m_RaygenRegion = {
                    .Address = m_SBT->GetDeviceAddress(0 * recordStride),
                    .Size = recordStride
                };
                m_MissRegion = {
                    .Address = m_SBT->GetDeviceAddress(1 * recordStride),
                    .Stride = recordStride,
                    .Size = recordStride
                };
                m_HitRegion = {
                    .Address = m_SBT->GetDeviceAddress(2 * recordStride),
                    .Stride = recordStride,
                    .Size = recordStride
                };
        ...
        virtual void Render(Nexus::TimeSpan time) override
        {
                ...
                Nexus::Graphics::GraphicsAPI::Vulkan)
            {
                ...
                m_CommandList->SetResourceSet(
                    {.TargetResourceSet = m_ResourceSet, .DynamicOffsets = {}}
                );
