...
public:
  ...
  virtual void Load() override {
    ...
    m_Texture = m_GraphicsDevice->CreateTexture2D(
        Nexus::FileSystem::GetFilePathAbsolute(
            "resources/demo/textures/brick.jpg"),
        false);
  ...
  virtual void Render(Nexus::Time time) override {
    ...
    m_ResourceSet->WriteCombinedImageSampler(m_Texture, m_Sampler,
                                             "texSampler");
    ...
    auto indexCount =
        m_Mesh->GetIndexBuffer()->GetDescription().Size / sizeof(unsigned int);
  ...
  virtual void RenderUI() override {
    ImGui::DragFloat2("Position", glm::value_ptr(m_Position), 0.1f, -1.0f,
                      1.0f);
  }
  ...
  void CreatePipeline() {
    ...
    pipelineDescription.VertexModule =
        m_GraphicsDevice->CreateShaderModuleFromSpirvFile(
            "resources/demo/shaders/uniform_buffers.vert.glsl",
            Nexus::Graphics::ShaderStage::Vertex);
    pipelineDescription.FragmentModule =
        m_GraphicsDevice->CreateShaderModuleFromSpirvFile(
            "resources/demo/shaders/uniform_buffers.frag.glsl",
            Nexus::Graphics::ShaderStage::Fragment);

    Nexus::Graphics::BufferDescription transformUniformBufferDesc;
    transformUniformBufferDesc.Size =
        sizeof(VB_UNIFORM_TRANSFORM_UNIFORM_BUFFER_DEMO);
