...
namespace Demos
{
    ...
    class UniformBufferDemo : public Demo
    {
      public:
        ...
        {
            ImGui::DragFloat2(
                "Position", glm::value_ptr(m_Position), 0.1f, -1.0f, 1.0f
            );
        }
      ...
      private:
        void CreatePipeline()
        {
            ...
            pipelineDescription
                .VertexModule = Nexus::Utils::GetOrCreateCachedShaderFromSpirvFile(
                m_GraphicsDevice,
                "resources/demo/shaders/uniform_buffers/uniform_buffers.vert.glsl",
        ...
        {
            return "Rendering a textured quad and uploading matrix transforms to "
                   "the GPU to change the position.";
        }
