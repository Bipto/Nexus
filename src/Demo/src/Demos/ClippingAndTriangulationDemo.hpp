...
public:
  ...
  virtual void Load() override {
    ...
    r1 = Nexus::Graphics::RoundedRectangle({450, 400}, {250, 250}, 15.0f, 15.0f,
                                           15.0f, 15.0f);
    r1.SetPointsPerCorner(8);
    r2 = Nexus::Graphics::RoundedRectangle({350, 400}, {400, 400}, 35.0f, 35.0f,
                                           35.0f, 35.0f);
  ...
  void DrawPolygonFill(const std::vector<glm::vec2> &points,
  ...
  virtual void Render(Nexus::Time time) override {
    ...
    const auto &windowSize =
        m_GraphicsDevice->GetPrimaryWindow()->GetWindowSize();
