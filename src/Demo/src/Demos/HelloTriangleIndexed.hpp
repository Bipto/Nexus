...
public:
  ...
  virtual void Load() override {
    ...
    m_VertexBuffer =
        m_GraphicsDevice->CreateVertexBuffer(vertexBufferDesc, vertices.data());
    ...
    m_IndexBuffer =
        m_GraphicsDevice->CreateIndexBuffer(indexBufferDesc, indices.data());
  }
  ...
  virtual void Render(Nexus::Time time) override {
    ...
    auto indexCount =
        m_IndexBuffer->GetDescription().Size / sizeof(unsigned int);
  ...
  void CreatePipeline() {
    ...
    pipelineDescription.VertexModule =
        m_GraphicsDevice->CreateShaderModuleFromSpirvFile(
            "resources/demo/shaders/hello_triangle.vert.glsl",
            Nexus::Graphics::ShaderStage::Vertex);
    pipelineDescription.FragmentModule =
        m_GraphicsDevice->CreateShaderModuleFromSpirvFile(
            "resources/demo/shaders/hello_triangle.frag.glsl",
