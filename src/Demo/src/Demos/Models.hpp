...
{
  public:
    ModelDemo(const std::string &name, Nexus::Application *app, Nexus::ImGuiUtils::ImGuiGraphicsRenderer *imGuiRenderer) : Demo(name, app, imGuiRenderer)
    {
    }
    ...
    virtual void Render(Nexus::Time time) override
    {
        ...
        m_TransformUniforms.Transform = glm::translate(glm::mat4(1.0f), {0.0f, 0.0f, 10.0f}) * glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), {0.0f, 1.0f, 0.0f});
