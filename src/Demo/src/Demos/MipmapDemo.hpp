...
public:
  ...
  virtual void Render(Nexus::Time time) override {
    ...
    Nexus::Ref<Nexus::Graphics::Sampler> sampler =
        m_GraphicsDevice->CreateSampler(samplerSpec);
  ...
  virtual void RenderUI() override {
    ...
    ImGui::DragInt("Mip", &m_SelectedMip, 1.0f, 0,
                   m_Texture->GetSpecification().MipLevels);
  }
  ...
  void CreatePipeline() {
    ...
    pipelineDescription.VertexModule =
        m_GraphicsDevice->CreateShaderModuleFromSpirvFile(
            "resources/demo/shaders/texturing.vert.glsl",
            Nexus::Graphics::ShaderStage::Vertex);
    pipelineDescription.FragmentModule =
        m_GraphicsDevice->CreateShaderModuleFromSpirvFile(
            "resources/demo/shaders/texturing.frag.glsl",
