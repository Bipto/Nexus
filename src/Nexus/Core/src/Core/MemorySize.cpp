...
namespace
{
    ...
    double ConvertUnitToBytes(Nexus::MemoryUnit unit)
    {
        switch (unit)
        {
        case Nexus::MemoryUnit::Bytes:
            return 1.0;
        case Nexus::MemoryUnit::Kilobytes:
            return SI_KilobytesBase;
        case Nexus::MemoryUnit::Kibibytes:
            return IEC_KibibytesBase;
        case Nexus::MemoryUnit::Megabytes:
            return std::pow(SI_KilobytesBase, 2);
        case Nexus::MemoryUnit::Mibibytes:
            return std::pow(IEC_KibibytesBase, 2);
        case Nexus::MemoryUnit::Gigabytes:
            return std::pow(SI_KilobytesBase, 3);
        case Nexus::MemoryUnit::Gibibytes:
            return std::pow(IEC_KibibytesBase, 3);
        case Nexus::MemoryUnit::Terabytes:
            return std::pow(SI_KilobytesBase, 4);
        case Nexus::MemoryUnit::Tibibytes:
            return std::pow(IEC_KibibytesBase, 4);
        case Nexus::MemoryUnit::Petabytes:
            return std ::pow(SI_KilobytesBase, 5);
        case Nexus::MemoryUnit::Pebibytes:
            return std ::pow(IEC_KibibytesBase, 5);
        default:
            return 1.0;
        }
    }
