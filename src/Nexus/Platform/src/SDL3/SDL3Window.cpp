...
namespace Nexus
{
	...
	WindowInfo SDL3Window::GetWindowInfo() const
	{
		...
		if (platform == "Windows")
		{
			...
			return Win32Info {
				.hWND	   = reinterpret_cast<uintptr_t>(SDL_GetPointerProperty(properties, SDL_PROP_WINDOW_WIN32_HWND_POINTER, nullptr)),
				.hDC	   = reinterpret_cast<uintptr_t>(SDL_GetPointerProperty(properties, SDL_PROP_WINDOW_WIN32_HDC_POINTER, nullptr)),
				.hINSTANCE = reinterpret_cast<uintptr_t>(SDL_GetPointerProperty(properties, SDL_PROP_WINDOW_WIN32_INSTANCE_POINTER, nullptr)),
			};
		}
		else if (platform == "Linux")
		{
			...
			if (driver == "x11")
			{
				...
				return X11Info {
					.display = reinterpret_cast<uintptr_t>(SDL_GetPointerProperty(properties, SDL_PROP_WINDOW_X11_DISPLAY_POINTER, nullptr)),
					.screen	 = static_cast<uint32_t>(SDL_GetNumberProperty(properties, SDL_PROP_WINDOW_X11_SCREEN_NUMBER, 0)),
					.window	 = static_cast<uint32_t>(SDL_GetNumberProperty(properties, SDL_PROP_WINDOW_X11_WINDOW_NUMBER, 0)),
				};
			}
			else if (driver == "wayland")
			{
				...
				return WaylandInfo {
					.display   = reinterpret_cast<uintptr_t>(SDL_GetPointerProperty(properties, SDL_PROP_WINDOW_WAYLAND_DISPLAY_POINTER, nullptr)),
					.surface   = reinterpret_cast<uintptr_t>(SDL_GetPointerProperty(properties, SDL_PROP_WINDOW_WAYLAND_SURFACE_POINTER, nullptr)),
					.viewport  = reinterpret_cast<uintptr_t>(SDL_GetPointerProperty(properties, SDL_PROP_WINDOW_WAYLAND_VIEWPORT_POINTER, nullptr)),
					.eglWindow = reinterpret_cast<uintptr_t>(SDL_GetPointerProperty(properties, SDL_PROP_WINDOW_WAYLAND_EGL_WINDOW_POINTER, nullptr)),
					.xdgSurface =
						reinterpret_cast<uintptr_t>(SDL_GetPointerProperty(properties, SDL_PROP_WINDOW_WAYLAND_XDG_SURFACE_POINTER, nullptr)),
					.xdgToplevel =
						reinterpret_cast<uintptr_t>(SDL_GetPointerProperty(properties, SDL_PROP_WINDOW_WAYLAND_XDG_TOPLEVEL_POINTER, nullptr)),
					.xdgTopLevelExportHandle =
						SDL_GetStringProperty(properties, SDL_PROP_WINDOW_WAYLAND_XDG_TOPLEVEL_EXPORT_HANDLE_STRING, "invalid"),
					.xdgPopup = reinterpret_cast<uintptr_t>(SDL_GetPointerProperty(properties, SDL_PROP_WINDOW_WAYLAND_XDG_POPUP_POINTER, nullptr)),
					.xdgPositioner =
						reinterpret_cast<uintptr_t>(SDL_GetPointerProperty(properties, SDL_PROP_WINDOW_WAYLAND_XDG_POSITIONER_POINTER, nullptr)),
				};
			}
			else
			{
				throw std::runtime_error("Failed to find a valid video driver");
			}
		}
		else if (platform == "Android")
		{
			...
			return AndroidInfo {
				.window	 = reinterpret_cast<uintptr_t>(SDL_GetPointerProperty(properties, SDL_PROP_WINDOW_ANDROID_WINDOW_POINTER, nullptr)),
				.surface = reinterpret_cast<uintptr_t>(SDL_GetPointerProperty(properties, SDL_PROP_WINDOW_ANDROID_SURFACE_POINTER, nullptr)),
			};
		}
		else if (platform == "iOS")
		{
			...
			info.openglFramebufferHandle =
				static_cast<uint32_t>(SDL_GetNumberProperty(properties, SDL_PROP_WINDOW_UIKIT_OPENGL_FRAMEBUFFER_NUMBER, 0));
			info.openglRenderbufferHandle =
				static_cast<uint32_t>(SDL_GetNumberProperty(properties, SDL_PROP_WINDOW_UIKIT_OPENGL_RENDERBUFFER_NUMBER, 0));
		...
		else if (platform == "Emscripten")
		{
			...
			return EmscriptenInfo {
				.canvasId = m_Description.CanvasId,
			};
		}
		else if (platform == "macOS")
		{
			...
			return MacOSInfo {
				.window		  = reinterpret_cast<uintptr_t>(SDL_GetPointerProperty(properties, SDL_PROP_WINDOW_COCOA_WINDOW_POINTER, nullptr)),
				.metalViewTag = static_cast<uint32_t>(SDL_GetNumberProperty(properties, SDL_PROP_WINDOW_COCOA_METAL_VIEW_TAG_NUMBER, 0)),
			};
		}
		else
		{
			throw std::runtime_error("Failed to find a supported platform");
		}
