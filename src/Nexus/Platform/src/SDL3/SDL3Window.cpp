...
namespace Nexus
{
    ...
    void SDL3Window::SetSize(uint32_t width, uint32_t height)
    {
        ...
        #else
                SDL_SetWindowSize(m_Window, size.X * GetDisplayScale(), size.Y *
        GetDisplayScale()); #endif */
    ...
    {
        for (auto &func : m_OnResizeCallbacks)
        {
            func(args);
        }
    }
    ...
    {
        for (auto &func : m_OnMoveCallbacks)
        {
            func(args);
        }
    }
    ...
    {
        for (auto &func : m_OnFocusGainCallbacks)
        {
            func();
        }
    }
    ...
    {
        for (auto &func : m_OnFocusLostCallbacks)
        {
            func();
        }
    }
    ...
    {
        for (auto &func : m_OnMaximizeCallbacks)
        {
            func();
        }
    }
    ...
    {
        for (auto &func : m_OnMinimizeCallbacks)
        {
            func();
        }
    }
    ...
    {
        for (auto &func : m_OnRestoreCallbacks)
        {
            func();
        }
    }
    ...
    {
        for (auto &func : m_OnShowCallbacks)
        {
            func();
        }
    }
    ...
    {
        for (auto &func : m_OnHideCallbacks)
        {
            func();
        }
    }
    ...
    {
        for (auto &func : m_OnExposeCallbacks)
        {
            func();
        }
    }
    ...
    void SDL3Window::InvokeKeyPressedCallback(const KeyPressedEventArgs &args)
    {
        ...
        for (auto &func : m_OnKeyPressedCallbacks)
        {
            func(args);
        }
    }
    ...
    void SDL3Window::InvokeKeyReleasedCallback(const KeyReleasedEventArgs &args)
    {
        ...
        for (auto &func : m_OnKeyReleasedCallbacks)
        {
            func(args);
        }
    }
    ...
    {
        for (auto &func : m_OnTextInputCallbacks)
        {
            func(args);
        }
    }
    ...
    {
        for (auto &func : m_OnTextEditCallbacks)
        {
            func(args);
        }
    }
    ...
    void SDL3Window::InvokeMousePressedCallback(const MouseButtonPressedEventArgs &args)
    {
        ...
        case MouseButton::X2:
            ...
            break;
        default:
            throw std::runtime_error("Failed to find valid mouse button");
        }

        for (auto &func : m_OnMouseButtonPressedCallbacks)
        {
            func(args);
        }
    }
    ...
    void SDL3Window::InvokeMouseReleasedCallback(const MouseButtonReleasedEventArgs &args)
    {
        ...
        for (auto &func : m_OnMouseButtonReleasedCallbacks)
        {
            func(args);
        }
    }
    ...
    void SDL3Window::InvokeMouseMovedCallback(const MouseMovedEventArgs &args)
    {
        ...
        for (auto &func : m_OnMouseMovedCallbacks)
        {
            func(args);
        }
    }
    ...
    {
        for (auto &func : m_OnMouseEnterCallbacks)
        {
            func();
        }
    }
    ...
    {
        for (auto &func : m_OnMouseLeaveCallbacks)
        {
            func();
        }
    }
    ...
    {
        for (auto &func : m_OnFileDropCallbacks)
        {
            func(args);
        }
    }
    ...
    bool SDL3Window::IsMouseButtonPressed(uint32_t mouseId, MouseButton state)
    {
        ...
        {
        case MouseButton::Left:
            return m_MouseStates[mouseId].LeftButton == MouseButtonState::Pressed;
        case MouseButton::Right:
            return m_MouseStates[mouseId].RightButton == MouseButtonState::Pressed;
        case MouseButton::Middle:
            return m_MouseStates[mouseId].MiddleButton == MouseButtonState::Pressed;
        case MouseButton::X1:
            return m_MouseStates[mouseId].X1Button == MouseButtonState::Pressed;
        case MouseButton::X2:
            return m_MouseStates[mouseId].X2Button == MouseButtonState::Pressed;
        default:
            throw std::runtime_error("Failed to find a valid button");
        }
    }
