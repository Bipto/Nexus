...
namespace Nexus::IO
{
    static const char *GetFileAccess(FileMode mode)
    {
        ...
        case FileMode::AppendText:
            return "a";
        case FileMode::ReadWriteText:
            return "r+";
        case FileMode::WriteNewText:
            return "w+";
        case FileMode::ReadAppendText:
            return "a+";
        ...
        case FileMode::ReadWriteBinary:
            return "rb+";
        case FileMode::WriteNewBinary:
            return "wb+";
        case FileMode::ReadAppendBinary:
            return "ab+";
        default:
            throw std::runtime_error("Invalid FileMode specified");
        }
    }
    ...
    static SDL_IOWhence GetSeekOrigin(SeekOrigin origin)
    {
        ...
        default:
            throw std::runtime_error("Invalid SeekOrigin specified");
        }
    }
