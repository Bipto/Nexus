...
namespace Nexus::SDL3
{
    KeyCode GetNexusKeyCodeFromSDLKeyCode(SDL_Keycode keycode)
    {
        ...
        case SDLK_KP_MEMSUBTRACT:
            return KeyCode::Keypad_MemSubtract;
        case SDLK_KP_7:
            return KeyCode::KeyPad_Seven;
        case SDLK_KP_8:
            return KeyCode::KeyPad_Eight;
        case SDLK_KP_9:
            return KeyCode::KeyPad_Nine;
        case SDLK_KP_PLUS:
            return KeyCode::KeyPad_Plus;
        case SDLK_KP_4:
            return KeyCode::KeyPad_Four;
        case SDLK_KP_5:
            return KeyCode::KeyPad_Five;
        case SDLK_KP_6:
            return KeyCode::KeyPad_Six;
        case SDLK_KP_1:
            return KeyCode::KeyPad_One;
        case SDLK_KP_2:
            return KeyCode::KeyPad_Two;
        case SDLK_KP_3:
            return KeyCode::KeyPad_Three;
        case SDLK_RETURN2:
            return KeyCode::Return2;
        case SDLK_KP_0:
            return KeyCode::KeyPad_Zero;
        case SDLK_KP_PERIOD:
            return KeyCode::Period;
        case SDLK_KP_ENTER:
        ...
        default:
            throw std::runtime_error("Failed to find a valid keycode");
        }
    }
    ...
    ScanCode GetNexusScanCodeFromSDLScanCode(SDL_Scancode scancode)
    {
        ...
        case SDL_SCANCODE_2:
            return ScanCode::Two;
        case SDL_SCANCODE_3:
            return ScanCode::Three;
        case SDL_SCANCODE_4:
            return ScanCode::Four;
        case SDL_SCANCODE_5:
            return ScanCode::Five;
        case SDL_SCANCODE_6:
            return ScanCode::Six;
        case SDL_SCANCODE_7:
            return ScanCode::Seven;
        case SDL_SCANCODE_8:
            return ScanCode::Eight;
        case SDL_SCANCODE_9:
            return ScanCode::Nine;
        case SDL_SCANCODE_0:
        ...
        case SDL_SCANCODE_KP_1:
            return ScanCode::KeyPadOne;
        case SDL_SCANCODE_KP_2:
            return ScanCode::KeyPadTwo;
        case SDL_SCANCODE_KP_3:
            return ScanCode::KeyPadThree;
        case SDL_SCANCODE_KP_4:
            return ScanCode::KeyPadFour;
        case SDL_SCANCODE_KP_5:
            return ScanCode::KeyPadFive;
        case SDL_SCANCODE_KP_6:
            return ScanCode::KeyPadSix;
        case SDL_SCANCODE_KP_7:
            return ScanCode::KeyPadSeven;
        case SDL_SCANCODE_KP_8:
            return ScanCode::KeyPadEight;
        case SDL_SCANCODE_KP_9:
            return ScanCode::KeyPadNine;
        case SDL_SCANCODE_KP_0:
            return ScanCode::KeyPadZero;
        ...
        case SDL_SCANCODE_MEDIA_NEXT_TRACK:
            return ScanCode::MediaNextTrack;
        case SDL_SCANCODE_MEDIA_PREVIOUS_TRACK:
            return ScanCode::MediaPreviousTrack;
        ...
        case SDL_SCANCODE_SOFTLEFT:
            return ScanCode::SoftLeft;
        case SDL_SCANCODE_SOFTRIGHT:
            return ScanCode::SoftRight;

        case SDL_SCANCODE_CALL:
            return ScanCode::Call;
        case SDL_SCANCODE_ENDCALL:
            return ScanCode::EndCall;

        default:
            throw std::runtime_error("Failed to find a valid scancode");
        }
    }
    ...
    FileDropType GetFileDropType(SDL_EventType type)
    {
        ...
        case SDL_EVENT_DROP_BEGIN:
            return FileDropType::Begin;
        case SDL_EVENT_DROP_COMPLETE:
            return FileDropType::Complete;
        case SDL_EVENT_DROP_FILE:
            return FileDropType::File;
        case SDL_EVENT_DROP_TEXT:
            return FileDropType::Text;
        case SDL_EVENT_DROP_POSITION:
            return FileDropType::Position;

        default:
            throw std::runtime_error("Failed to find valid event type");
        }
    }
