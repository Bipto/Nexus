...
namespace Nexus
{
    ...
    class NX_PLATFORM_API IWindow
    {
      public:
        ...
        /// @brief A virtual method that performs all actions needed to process and
        /// update the window
        ...
        /// @return A Nexus::Point containing two integers representing the pixel
        /// size of the window
        ...
        /// @brief A method that returns the display scale of the monitor that the
        /// window is on
        ...
        /// @brief A virtual method that sets how often the window should be rendered
        /// to
        /// @param amount The amount of times per second to render, use null optional
        /// to disable timings
        ...
        /// @param amount The amount of times per second to update, use null optional
        /// to disable timings
        ...
        /// @param amount The amount of times per second to ticked, use null optional
        /// to disable timings
        virtual void SetTicksPerSecond(std::optional<uint32_t> amount) = 0;

        /// @brief A virtual method that sets the function to call when the window is
        /// rendered to
        /// @param func The function to call when rendering
        virtual void SetRenderFunction(
        ...
        virtual void SetUpdateFunction(
            std::function<void(Nexus::TimeSpan time)> func
        ) = 0;
        ...
        virtual void SetTickFunction(
            std::function<void(Nexus::TimeSpan time)> func
        ) = 0;

        /// @brief A virtual method that sets whether the mouse is invisible and
        /// locked to the window
        /// @param enabled Whether the mouse is relative of not
        virtual void SetRelativeMouseMode(bool enabled) = 0;

        /// @brief A virtual method that returns a struct containing the native
        /// window data of the IWindow
        /// @return
        ...
        virtual void AddFileDropCallback(
