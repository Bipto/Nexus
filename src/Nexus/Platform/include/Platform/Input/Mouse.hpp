...
namespace Nexus
{
    ...
    struct MouseState
    {
        ...
        /// @brief A Nexus::Point containing two integers representing the position
        /// of the mouse cursor
        std::pair<float, float> MousePosition;

        /// @brief A Nexus::Point containing two floats representing the movement of
        /// the mouse
        std::pair<float, float> MouseMovement;
