...
namespace Nexus::UI
{
	...
	void PictureBox::OnRender(Nexus::Graphics::BatchRenderer *renderer)
	{
		...
		Nexus::Graphics::RoundedRectangle outlineRect({rect.GetLeft() + m_BorderThickness,
		...
		if (m_Texture)
		{
			Nexus::Graphics::RoundedRectangle textureBoundsWidthPadding(rect.GetLeft() + m_Padding.Left,
