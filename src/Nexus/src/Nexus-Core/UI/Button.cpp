...
namespace Nexus::UI
{
    ...
    void Nexus::UI::Button::OnRender(Nexus::Graphics::BatchRenderer *renderer)
    {
        ...
        {
            Nexus::Graphics::RoundedRectangle border(rrect.GetLeft() + m_BorderThickness, rrect.GetTop() + m_BorderThickness, rrect.GetWidth() - m_BorderThickness, rrect.GetHeight() - m_BorderThickness);
