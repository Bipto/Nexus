...
enum SamplerState {
  /// @brief Pixels will be linearly interpolated and pixels out of range will
  /// be clamped to the nearest value in the texture
  LinearClamp,

  /// @brief Pixels will be linearly interpolated and pixels out of range will
  /// be wrapped around into the texture
  LinearWrap,

  /// @brief Pixels will be clamped to the nearest value and pixels out of range
  /// will be clamped to the nearest value in the texture
  PointClamp,

  /// @brief Pixels will be clamped to the nearest value and pixels out of range
  /// will be wrapped around into the texture
  PointWrap
};

enum class BorderColor { TransparentBlack, OpaqueBlack, OpaqueWhite };

enum class SamplerAddressMode { Border, Clamp, Mirror, MirrorOnce, Wrap };
