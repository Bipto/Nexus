...
class Mesh
{
  public:
    ...
    Mesh(Ref<VertexBuffer> vertexBuffer, Ref<IndexBuffer> indexBuffer, const std::string &name = "Mesh") : m_VertexBuffer(vertexBuffer), m_IndexBuffer(indexBuffer), m_Name(name)
    {
    }
