...
namespace Nexus::Graphics
{
	uint32_t GetShaderDataTypeSize(ShaderDataType type)
	{
		switch (type)
		{
			...
			case ShaderDataType::Half: return 2; break;
			case ShaderDataType::Half2: return 2 * 2; break;
			case ShaderDataType::Half4: return 2 * 4; break;
			...
			case ShaderDataType::ShortNormalized: return 2; break;
			case ShaderDataType::Short2: return 2 * 2; break;
			case ShaderDataType::Short2Normalized: return 2 * 2; break;
			case ShaderDataType::Short4: return 2 * 4; break;
			case ShaderDataType::Short4Normalized: return 2 * 4; break;
			...
			case ShaderDataType::UShort: return 2; break;
			case ShaderDataType::UShort2: return 2 * 2; break;
			case ShaderDataType::UShort4: return 2 * 4; break;
			case ShaderDataType::UShortNormalized: return 2; break;
			case ShaderDataType::UShort2Normalized: return 2 * 2; break;
			case ShaderDataType::UShort4Normalized: return 2 * 4; break;
