...
struct VertexPositionTexCoord
{
    ...
    static Nexus::Graphics::VertexBufferLayout GetLayout()
    {
        Nexus::Graphics::VertexBufferLayout layout = {{Nexus::Graphics::ShaderDataType::Float3, "TEXCOORD"}, {Nexus::Graphics::ShaderDataType::Float2, "TEXCOORD"}};
        return layout;
    }
};
...
struct VertexPositionTexCoordColor
{
    ...
    VertexPositionTexCoordColor(const glm::vec3 &position, const glm::vec2 &texCoords, const glm::vec4 &color) : Position(position), TexCoords(texCoords), Color(color)
    {
    }
    ...
    static Nexus::Graphics::VertexBufferLayout GetLayout()
    {
        Nexus::Graphics::VertexBufferLayout layout = {
            {Nexus::Graphics::ShaderDataType::Float3, "TEXCOORD"}, {Nexus::Graphics::ShaderDataType::Float2, "TEXCOORD"}, {Nexus::Graphics::ShaderDataType::Float4, "TEXCOORD"}};
        return layout;
    }
};
...
struct VertexPositionTexCoordNormal
{
    ...
    VertexPositionTexCoordNormal(const glm::vec3 &position, const glm::vec2 &texCoords, const glm::vec3 &normal) : Position(position), TexCoords(texCoords), Normal(normal)
    {
    }
    ...
    {
        Nexus::Graphics::VertexBufferLayout layout = {
            {Nexus::Graphics::ShaderDataType::Float3, "TEXCOORD"}, {Nexus::Graphics::ShaderDataType::Float2, "TEXCOORD"}, {Nexus::Graphics::ShaderDataType::Float3, "TEXCOORD"}};
        return layout;
    }
};
...
struct VertexPositionTexCoordNormalTangentBitangent
{
    ...
    /// @param texCoords A const reference to 2 floating point values representing the texture coordinates
    /// @param normal A const reference to 3 floating point values representing the normal
    VertexPositionTexCoordNormalTangentBitangent(const glm::vec3 &position, const glm::vec2 &texCoords, const glm::vec3 &normal, const glm::vec3 &tangent,
...
namespace Utilities
{
std::vector<VertexPositionTexCoordNormalTangentBitangent> GenerateTangentAndBinormals(const std::vector<Nexus::Graphics::VertexPositionTexCoordNormal> &vertices);
}
} // namespace Nexus::Graphics