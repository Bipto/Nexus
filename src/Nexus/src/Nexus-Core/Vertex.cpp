...
std::vector<VertexPositionTexCoordNormalTangentBitangent>
Utilities::GenerateTangentAndBinormals(
  ...
  for (int i = 0; i < vertices.size(); i += 3) {
    ...
    VertexPositionTexCoordNormalTangentBitangent v1(pos1, uv1, normal1, tangent,
                                                    bitangent);
    VertexPositionTexCoordNormalTangentBitangent v2(pos2, uv2, normal2, tangent,
                                                    bitangent);
    VertexPositionTexCoordNormalTangentBitangent v3(pos3, uv3, normal3, tangent,
                                                    bitangent);
