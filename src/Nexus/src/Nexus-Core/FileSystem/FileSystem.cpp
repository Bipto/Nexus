...
std::string
Nexus::FileSystem::ReadFileToStringAbsolute(const std::string &filepath) {
...
void Nexus::FileSystem::WriteFileAbsolute(const std::string &filepath,
...
void Nexus::FileSystem::WriteFile(const std::string &filepath,
                                  const std::string &text) {
  std::string fullpath = GetRootDirectory() + filepath;
...
std::string
Nexus::FileSystem::GetFilePathAbsolute(const std::string &filepath) {
