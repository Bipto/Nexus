...
public:
  ...
  /// @brief A static method representing whether the left mouse button was
  /// pressed
  /// @return A boolean value representing whether the left mouse button was
  /// pressed
  ...
  /// @brief A static method representing whether the right mouse button was
  /// pressed
  /// @return A boolean value representing whether the right mouse button was
  /// pressed
  ...
  /// @brief A static method representing whether the middle mouse button was
  /// pressed
  /// @return A boolean value representing whether the middle mouse button was
  /// pressed
  ...
  /// @brief A static method representing the current position of the mouse
  /// pointer
  ...
  /// scroll wheel
  /// @return A floating point value representing the mouse scroll X since the
  /// start of the application
  static float GetMouseScrollX();

  /// @brief A static method representing the mouse scroll X movement between
  /// frames
  /// @return A floating point value representing the change in mouse scroll X
  /// between frames
  static float GetMouseScrollMovementX();

  /// @brief A static method representing the current Y position of the mouse
  /// scroll wheel
  /// @return A floating point value representing the mouse scroll Y since the
  /// start of the application
  static float GetMouseScrollY();

  /// @brief A static method representing the mouse scroll Y movement between
  /// frames
  /// @return A floating point value representing the change in mouse scroll Y
  /// between frames
  ...
  /// @brief A static method representing whether a key was pressed on the
  /// keyboard
  ...
  /// @brief A static method representing whether a key was released on the
  /// keyboard
  /// @param code An enum value representing the key to check the state of
  ...
  /// @brief A static method representing whether any gamepads are connected to
  /// the device
  /// @return A boolean value representing whether any gamepads are available
  static bool IsGamepadConnected();

  /// @brief A static method representing the number of gamepads connected to
  /// the device
  ...
  /// @brief A static method representing whether a key was released on a
  /// gamepad
  /// @param index The index of the controller to check
  /// @param button An enum value representing the button to check
  ...
  /// @brief A static method representing the current state of the gamepad left
  /// axis
  /// @param index The index of the controller to check
  /// @return A Nexus::Point containing two floating point values representing
  /// the position of the left axis
  static Point2D<float> GetGamepadAxisLeft(uint32_t index);

  /// @brief A static method representing the current state of the gamepad right
  /// axis
  /// @param index The index of the controller to check
  /// @return A Nexus::Point containing two floating point values representing
  /// the position of the right axis
  static Point2D<float> GetGamepadAxisRight(uint32_t index);

  /// @brief A static method representing the current state of the gamepad left
  /// trigger
  /// @param index The index of the controller to check
  /// @return A floating point value representing the current position of the
  /// left trigger
  ...
  static void GamepadRumble(uint32_t index, uint16_t lowFrequency,
  ...
  /// @param milliseconds The number of milliseconds to rumble for
  static void GamepadRumbleTriggers(uint32_t index, uint16_t left,
                                    uint16_t right, uint32_t milliseconds);
  ...
  static void GamepadSetLED(uint32_t index, uint8_t red, uint8_t green,
                            uint8_t blue);
