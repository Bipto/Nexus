...
Ref<AudioBuffer>
AudioDeviceOpenAL::CreateAudioBufferFromWavFile(const std::string &filepath) {
...
Ref<AudioBuffer>
AudioDeviceOpenAL::CreateAudioBufferFromMP3File(const std::string &filepath) {
...
AudioDeviceOpenAL::CreateAudioSource(Ref<Audio::AudioBuffer> buffer) {
  return CreateRef<AudioSourceOpenAL>(buffer);
}

void AudioDeviceOpenAL::PlaySource(Ref<Audio::AudioSource> source) {
  Ref<AudioSourceOpenAL> s =
      std::dynamic_pointer_cast<Audio::AudioSourceOpenAL>(source);
