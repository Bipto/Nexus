...
ShaderModuleD3D12::ShaderModuleD3D12(
  ...
  utils->CreateBlob(m_ModuleSpecification.Source.c_str(),
                    m_ModuleSpecification.Source.length(), CP_UTF8,
  ...
  std::vector<LPCWSTR> compilationArguments = {L"-E", wsEntryPoint.c_str(),
                                               L"-T", wsShaderVersion.c_str(),
...
IDxcBlob *ShaderModuleD3D12::GetBlob() const { return m_ShaderBlob.Get(); }
} // namespace Nexus::Graphics
