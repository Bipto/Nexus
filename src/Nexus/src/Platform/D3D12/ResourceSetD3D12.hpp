...
public:
  ResourceSetD3D12(const ResourceSetSpecification &spec,
...
private:
  ...
  Microsoft::WRL::ComPtr<ID3D12DescriptorHeap>
      m_TextureConstantBufferDescriptorHeap = nullptr;
  ...
  std::map<uint32_t, D3D12_CPU_DESCRIPTOR_HANDLE>
      m_ConstantBufferCPUDescriptors;
  std::map<uint32_t, D3D12_GPU_DESCRIPTOR_HANDLE>
      m_ConstantBufferGPUDescriptors;
