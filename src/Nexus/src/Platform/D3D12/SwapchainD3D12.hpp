...
public:
  SwapchainD3D12(Window *window, GraphicsDevice *device,
  ...
  RetrieveRenderTargetViewDescriptorHandle() const;
...
private:
  ...
  Microsoft::WRL::ComPtr<ID3D12DescriptorHeap> m_DepthTextureDescriptorHeap =
      nullptr;
