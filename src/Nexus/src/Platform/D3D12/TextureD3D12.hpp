...
public:
  Texture2D_D3D12(GraphicsDeviceD3D12 *device,
...
public:
  ...
  void SetResourceState(uint32_t arrayLayer, uint32_t mipLevel,
                        D3D12_RESOURCE_STATES state);
  D3D12_RESOURCE_STATES GetResourceState(uint32_t arrayLayer,
                                         uint32_t mipLevel);
