...
public:
  GraphicsDeviceVk(const GraphicsDeviceSpecification &createInfo,
                   Window *window, const SwapchainSpecification &swapchainSpec);
  ...
  CreateCommandList(const CommandListSpecification &spec = {});
  ...
  void TransitionVulkanImageLayout(VkCommandBuffer cmdBuffer, VkImage image,
  ...
  Vk::AllocatedBuffer CreateBuffer(size_t allocSize, VkBufferUsageFlags usage,
