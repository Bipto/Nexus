...
{
	TextureViewVk::TextureViewVk(const TextureViewDescription &desc, GraphicsDeviceVk *device) : m_Description(desc), m_Device(device)
	{
		...
		createInfo.subresourceRange.aspectMask =
			texture->IsDepth() ? VK_IMAGE_ASPECT_DEPTH_BIT | VK_IMAGE_ASPECT_STENCIL_BIT : VK_IMAGE_ASPECT_COLOR_BIT;
