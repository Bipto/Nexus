...
static int glad_gl_find_extensions_gl(GladGLContext *context) {
    ...
    context->_3DFX_multisample = glad_gl_has_extension(exts, exts_i, "GL_3DFX_multisample");
    context->_3DFX_tbuffer = glad_gl_has_extension(exts, exts_i, "GL_3DFX_tbuffer");
    context->_3DFX_texture_compression_FXT1 = glad_gl_has_extension(exts, exts_i, "GL_3DFX_texture_compression_FXT1");
    context->AMD_blend_minmax_factor = glad_gl_has_extension(exts, exts_i, "GL_AMD_blend_minmax_factor");
    context->AMD_conservative_depth = glad_gl_has_extension(exts, exts_i, "GL_AMD_conservative_depth");
    context->AMD_debug_output = glad_gl_has_extension(exts, exts_i, "GL_AMD_debug_output");
    context->AMD_depth_clamp_separate = glad_gl_has_extension(exts, exts_i, "GL_AMD_depth_clamp_separate");
    ...
    context->AMD_framebuffer_sample_positions = glad_gl_has_extension(exts, exts_i, "GL_AMD_framebuffer_sample_positions");
    context->AMD_gcn_shader = glad_gl_has_extension(exts, exts_i, "GL_AMD_gcn_shader");
    context->AMD_gpu_shader_half_float = glad_gl_has_extension(exts, exts_i, "GL_AMD_gpu_shader_half_float");
    context->AMD_gpu_shader_int16 = glad_gl_has_extension(exts, exts_i, "GL_AMD_gpu_shader_int16");
    context->AMD_gpu_shader_int64 = glad_gl_has_extension(exts, exts_i, "GL_AMD_gpu_shader_int64");
    context->AMD_interleaved_elements = glad_gl_has_extension(exts, exts_i, "GL_AMD_interleaved_elements");
    context->AMD_multi_draw_indirect = glad_gl_has_extension(exts, exts_i, "GL_AMD_multi_draw_indirect");
    context->AMD_name_gen_delete = glad_gl_has_extension(exts, exts_i, "GL_AMD_name_gen_delete");
    context->AMD_occlusion_query_event = glad_gl_has_extension(exts, exts_i, "GL_AMD_occlusion_query_event");
    context->AMD_performance_monitor = glad_gl_has_extension(exts, exts_i, "GL_AMD_performance_monitor");
    context->AMD_pinned_memory = glad_gl_has_extension(exts, exts_i, "GL_AMD_pinned_memory");
    context->AMD_query_buffer_object = glad_gl_has_extension(exts, exts_i, "GL_AMD_query_buffer_object");
    context->AMD_sample_positions = glad_gl_has_extension(exts, exts_i, "GL_AMD_sample_positions");
    context->AMD_seamless_cubemap_per_texture = glad_gl_has_extension(exts, exts_i, "GL_AMD_seamless_cubemap_per_texture");
    context->AMD_shader_atomic_counter_ops = glad_gl_has_extension(exts, exts_i, "GL_AMD_shader_atomic_counter_ops");
    context->AMD_shader_ballot = glad_gl_has_extension(exts, exts_i, "GL_AMD_shader_ballot");
    context->AMD_shader_explicit_vertex_parameter = glad_gl_has_extension(exts, exts_i, "GL_AMD_shader_explicit_vertex_parameter");
    context->AMD_shader_gpu_shader_half_float_fetch = glad_gl_has_extension(exts, exts_i, "GL_AMD_shader_gpu_shader_half_float_fetch");
    context->AMD_shader_image_load_store_lod = glad_gl_has_extension(exts, exts_i, "GL_AMD_shader_image_load_store_lod");
    context->AMD_shader_stencil_export = glad_gl_has_extension(exts, exts_i, "GL_AMD_shader_stencil_export");
    context->AMD_shader_trinary_minmax = glad_gl_has_extension(exts, exts_i, "GL_AMD_shader_trinary_minmax");
    context->AMD_sparse_texture = glad_gl_has_extension(exts, exts_i, "GL_AMD_sparse_texture");
    context->AMD_stencil_operation_extended = glad_gl_has_extension(exts, exts_i, "GL_AMD_stencil_operation_extended");
    context->AMD_texture_gather_bias_lod = glad_gl_has_extension(exts, exts_i, "GL_AMD_texture_gather_bias_lod");
    context->AMD_texture_texture4 = glad_gl_has_extension(exts, exts_i, "GL_AMD_texture_texture4");
    context->AMD_transform_feedback3_lines_triangles = glad_gl_has_extension(exts, exts_i, "GL_AMD_transform_feedback3_lines_triangles");
    context->AMD_transform_feedback4 = glad_gl_has_extension(exts, exts_i, "GL_AMD_transform_feedback4");
    context->AMD_vertex_shader_layer = glad_gl_has_extension(exts, exts_i, "GL_AMD_vertex_shader_layer");
    context->AMD_vertex_shader_tessellator = glad_gl_has_extension(exts, exts_i, "GL_AMD_vertex_shader_tessellator");
    context->AMD_vertex_shader_viewport_index = glad_gl_has_extension(exts, exts_i, "GL_AMD_vertex_shader_viewport_index");
    context->APPLE_aux_depth_stencil = glad_gl_has_extension(exts, exts_i, "GL_APPLE_aux_depth_stencil");
    context->APPLE_client_storage = glad_gl_has_extension(exts, exts_i, "GL_APPLE_client_storage");
    context->APPLE_element_array = glad_gl_has_extension(exts, exts_i, "GL_APPLE_element_array");
    context->APPLE_fence = glad_gl_has_extension(exts, exts_i, "GL_APPLE_fence");
    context->APPLE_float_pixels = glad_gl_has_extension(exts, exts_i, "GL_APPLE_float_pixels");
    context->APPLE_flush_buffer_range = glad_gl_has_extension(exts, exts_i, "GL_APPLE_flush_buffer_range");
    context->APPLE_object_purgeable = glad_gl_has_extension(exts, exts_i, "GL_APPLE_object_purgeable");
    context->APPLE_rgb_422 = glad_gl_has_extension(exts, exts_i, "GL_APPLE_rgb_422");
    context->APPLE_row_bytes = glad_gl_has_extension(exts, exts_i, "GL_APPLE_row_bytes");
    context->APPLE_specular_vector = glad_gl_has_extension(exts, exts_i, "GL_APPLE_specular_vector");
    context->APPLE_texture_range = glad_gl_has_extension(exts, exts_i, "GL_APPLE_texture_range");
    context->APPLE_transform_hint = glad_gl_has_extension(exts, exts_i, "GL_APPLE_transform_hint");
    context->APPLE_vertex_array_object = glad_gl_has_extension(exts, exts_i, "GL_APPLE_vertex_array_object");
    context->APPLE_vertex_array_range = glad_gl_has_extension(exts, exts_i, "GL_APPLE_vertex_array_range");
    context->APPLE_vertex_program_evaluators = glad_gl_has_extension(exts, exts_i, "GL_APPLE_vertex_program_evaluators");
    context->APPLE_ycbcr_422 = glad_gl_has_extension(exts, exts_i, "GL_APPLE_ycbcr_422");
    ...
    context->ARB_ES3_2_compatibility = glad_gl_has_extension(exts, exts_i, "GL_ARB_ES3_2_compatibility");
    context->ARB_ES3_compatibility = glad_gl_has_extension(exts, exts_i, "GL_ARB_ES3_compatibility");
    context->ARB_arrays_of_arrays = glad_gl_has_extension(exts, exts_i, "GL_ARB_arrays_of_arrays");
    context->ARB_base_instance = glad_gl_has_extension(exts, exts_i, "GL_ARB_base_instance");
    context->ARB_bindless_texture = glad_gl_has_extension(exts, exts_i, "GL_ARB_bindless_texture");
    ...
    context->ARB_cl_event = glad_gl_has_extension(exts, exts_i, "GL_ARB_cl_event");
    ...
    context->ARB_compatibility = glad_gl_has_extension(exts, exts_i, "GL_ARB_compatibility");
    context->ARB_compressed_texture_pixel_storage = glad_gl_has_extension(exts, exts_i, "GL_ARB_compressed_texture_pixel_storage");
    context->ARB_compute_shader = glad_gl_has_extension(exts, exts_i, "GL_ARB_compute_shader");
    context->ARB_compute_variable_group_size = glad_gl_has_extension(exts, exts_i, "GL_ARB_compute_variable_group_size");
    context->ARB_conditional_render_inverted = glad_gl_has_extension(exts, exts_i, "GL_ARB_conditional_render_inverted");
    context->ARB_conservative_depth = glad_gl_has_extension(exts, exts_i, "GL_ARB_conservative_depth");
    ...
    context->ARB_cull_distance = glad_gl_has_extension(exts, exts_i, "GL_ARB_cull_distance");
    context->ARB_debug_output = glad_gl_has_extension(exts, exts_i, "GL_ARB_debug_output");
    context->ARB_depth_buffer_float = glad_gl_has_extension(exts, exts_i, "GL_ARB_depth_buffer_float");
    context->ARB_depth_clamp = glad_gl_has_extension(exts, exts_i, "GL_ARB_depth_clamp");
    context->ARB_depth_texture = glad_gl_has_extension(exts, exts_i, "GL_ARB_depth_texture");
    context->ARB_derivative_control = glad_gl_has_extension(exts, exts_i, "GL_ARB_derivative_control");
    ...
    context->ARB_enhanced_layouts = glad_gl_has_extension(exts, exts_i, "GL_ARB_enhanced_layouts");
    context->ARB_explicit_attrib_location = glad_gl_has_extension(exts, exts_i, "GL_ARB_explicit_attrib_location");
    context->ARB_explicit_uniform_location = glad_gl_has_extension(exts, exts_i, "GL_ARB_explicit_uniform_location");
    context->ARB_fragment_coord_conventions = glad_gl_has_extension(exts, exts_i, "GL_ARB_fragment_coord_conventions");
    context->ARB_fragment_layer_viewport = glad_gl_has_extension(exts, exts_i, "GL_ARB_fragment_layer_viewport");
    context->ARB_fragment_program = glad_gl_has_extension(exts, exts_i, "GL_ARB_fragment_program");
    context->ARB_fragment_program_shadow = glad_gl_has_extension(exts, exts_i, "GL_ARB_fragment_program_shadow");
    context->ARB_fragment_shader = glad_gl_has_extension(exts, exts_i, "GL_ARB_fragment_shader");
    context->ARB_fragment_shader_interlock = glad_gl_has_extension(exts, exts_i, "GL_ARB_fragment_shader_interlock");
    ...
    context->ARB_framebuffer_sRGB = glad_gl_has_extension(exts, exts_i, "GL_ARB_framebuffer_sRGB");
    ...
    context->ARB_gpu_shader5 = glad_gl_has_extension(exts, exts_i, "GL_ARB_gpu_shader5");
    context->ARB_gpu_shader_fp64 = glad_gl_has_extension(exts, exts_i, "GL_ARB_gpu_shader_fp64");
    context->ARB_gpu_shader_int64 = glad_gl_has_extension(exts, exts_i, "GL_ARB_gpu_shader_int64");
    context->ARB_half_float_pixel = glad_gl_has_extension(exts, exts_i, "GL_ARB_half_float_pixel");
    context->ARB_half_float_vertex = glad_gl_has_extension(exts, exts_i, "GL_ARB_half_float_vertex");
    ...
    context->ARB_map_buffer_alignment = glad_gl_has_extension(exts, exts_i, "GL_ARB_map_buffer_alignment");
    context->ARB_map_buffer_range = glad_gl_has_extension(exts, exts_i, "GL_ARB_map_buffer_range");
    context->ARB_matrix_palette = glad_gl_has_extension(exts, exts_i, "GL_ARB_matrix_palette");
    ...
    context->ARB_occlusion_query2 = glad_gl_has_extension(exts, exts_i, "GL_ARB_occlusion_query2");
    context->ARB_parallel_shader_compile = glad_gl_has_extension(exts, exts_i, "GL_ARB_parallel_shader_compile");
    context->ARB_pipeline_statistics_query = glad_gl_has_extension(exts, exts_i, "GL_ARB_pipeline_statistics_query");
    context->ARB_pixel_buffer_object = glad_gl_has_extension(exts, exts_i, "GL_ARB_pixel_buffer_object");
    context->ARB_point_parameters = glad_gl_has_extension(exts, exts_i, "GL_ARB_point_parameters");
    context->ARB_point_sprite = glad_gl_has_extension(exts, exts_i, "GL_ARB_point_sprite");
    context->ARB_polygon_offset_clamp = glad_gl_has_extension(exts, exts_i, "GL_ARB_polygon_offset_clamp");
    context->ARB_post_depth_coverage = glad_gl_has_extension(exts, exts_i, "GL_ARB_post_depth_coverage");
    ...
    context->ARB_query_buffer_object = glad_gl_has_extension(exts, exts_i, "GL_ARB_query_buffer_object");
    context->ARB_robust_buffer_access_behavior = glad_gl_has_extension(exts, exts_i, "GL_ARB_robust_buffer_access_behavior");
    context->ARB_robustness = glad_gl_has_extension(exts, exts_i, "GL_ARB_robustness");
    context->ARB_robustness_isolation = glad_gl_has_extension(exts, exts_i, "GL_ARB_robustness_isolation");
    context->ARB_sample_locations = glad_gl_has_extension(exts, exts_i, "GL_ARB_sample_locations");
    ...
    context->ARB_seamless_cube_map = glad_gl_has_extension(exts, exts_i, "GL_ARB_seamless_cube_map");
    context->ARB_seamless_cubemap_per_texture = glad_gl_has_extension(exts, exts_i, "GL_ARB_seamless_cubemap_per_texture");
    context->ARB_separate_shader_objects = glad_gl_has_extension(exts, exts_i, "GL_ARB_separate_shader_objects");
    context->ARB_shader_atomic_counter_ops = glad_gl_has_extension(exts, exts_i, "GL_ARB_shader_atomic_counter_ops");
    context->ARB_shader_atomic_counters = glad_gl_has_extension(exts, exts_i, "GL_ARB_shader_atomic_counters");
    context->ARB_shader_ballot = glad_gl_has_extension(exts, exts_i, "GL_ARB_shader_ballot");
    context->ARB_shader_bit_encoding = glad_gl_has_extension(exts, exts_i, "GL_ARB_shader_bit_encoding");
    context->ARB_shader_clock = glad_gl_has_extension(exts, exts_i, "GL_ARB_shader_clock");
    context->ARB_shader_draw_parameters = glad_gl_has_extension(exts, exts_i, "GL_ARB_shader_draw_parameters");
    context->ARB_shader_group_vote = glad_gl_has_extension(exts, exts_i, "GL_ARB_shader_group_vote");
    context->ARB_shader_image_load_store = glad_gl_has_extension(exts, exts_i, "GL_ARB_shader_image_load_store");
    context->ARB_shader_image_size = glad_gl_has_extension(exts, exts_i, "GL_ARB_shader_image_size");
    context->ARB_shader_objects = glad_gl_has_extension(exts, exts_i, "GL_ARB_shader_objects");
    context->ARB_shader_precision = glad_gl_has_extension(exts, exts_i, "GL_ARB_shader_precision");
    context->ARB_shader_stencil_export = glad_gl_has_extension(exts, exts_i, "GL_ARB_shader_stencil_export");
    ...
    context->ARB_shader_texture_image_samples = glad_gl_has_extension(exts, exts_i, "GL_ARB_shader_texture_image_samples");
    context->ARB_shader_texture_lod = glad_gl_has_extension(exts, exts_i, "GL_ARB_shader_texture_lod");
    context->ARB_shader_viewport_layer_array = glad_gl_has_extension(exts, exts_i, "GL_ARB_shader_viewport_layer_array");
    context->ARB_shading_language_100 = glad_gl_has_extension(exts, exts_i, "GL_ARB_shading_language_100");
    context->ARB_shading_language_420pack = glad_gl_has_extension(exts, exts_i, "GL_ARB_shading_language_420pack");
    context->ARB_shading_language_include = glad_gl_has_extension(exts, exts_i, "GL_ARB_shading_language_include");
    context->ARB_shading_language_packing = glad_gl_has_extension(exts, exts_i, "GL_ARB_shading_language_packing");
    context->ARB_shadow = glad_gl_has_extension(exts, exts_i, "GL_ARB_shadow");
    context->ARB_shadow_ambient = glad_gl_has_extension(exts, exts_i, "GL_ARB_shadow_ambient");
    context->ARB_sparse_buffer = glad_gl_has_extension(exts, exts_i, "GL_ARB_sparse_buffer");
    context->ARB_sparse_texture = glad_gl_has_extension(exts, exts_i, "GL_ARB_sparse_texture");
    context->ARB_sparse_texture2 = glad_gl_has_extension(exts, exts_i, "GL_ARB_sparse_texture2");
    context->ARB_sparse_texture_clamp = glad_gl_has_extension(exts, exts_i, "GL_ARB_sparse_texture_clamp");
    context->ARB_spirv_extensions = glad_gl_has_extension(exts, exts_i, "GL_ARB_spirv_extensions");
    context->ARB_stencil_texturing = glad_gl_has_extension(exts, exts_i, "GL_ARB_stencil_texturing");
    ...
    context->ARB_texture_border_clamp = glad_gl_has_extension(exts, exts_i, "GL_ARB_texture_border_clamp");
    context->ARB_texture_buffer_object = glad_gl_has_extension(exts, exts_i, "GL_ARB_texture_buffer_object");
    context->ARB_texture_buffer_object_rgb32 = glad_gl_has_extension(exts, exts_i, "GL_ARB_texture_buffer_object_rgb32");
    ...
    context->ARB_texture_cube_map = glad_gl_has_extension(exts, exts_i, "GL_ARB_texture_cube_map");
    context->ARB_texture_cube_map_array = glad_gl_has_extension(exts, exts_i, "GL_ARB_texture_cube_map_array");
    context->ARB_texture_env_add = glad_gl_has_extension(exts, exts_i, "GL_ARB_texture_env_add");
    context->ARB_texture_env_combine = glad_gl_has_extension(exts, exts_i, "GL_ARB_texture_env_combine");
    context->ARB_texture_env_crossbar = glad_gl_has_extension(exts, exts_i, "GL_ARB_texture_env_crossbar");
    context->ARB_texture_env_dot3 = glad_gl_has_extension(exts, exts_i, "GL_ARB_texture_env_dot3");
    context->ARB_texture_filter_anisotropic = glad_gl_has_extension(exts, exts_i, "GL_ARB_texture_filter_anisotropic");
    context->ARB_texture_filter_minmax = glad_gl_has_extension(exts, exts_i, "GL_ARB_texture_filter_minmax");
    context->ARB_texture_float = glad_gl_has_extension(exts, exts_i, "GL_ARB_texture_float");
    context->ARB_texture_gather = glad_gl_has_extension(exts, exts_i, "GL_ARB_texture_gather");
    context->ARB_texture_mirror_clamp_to_edge = glad_gl_has_extension(exts, exts_i, "GL_ARB_texture_mirror_clamp_to_edge");
    context->ARB_texture_mirrored_repeat = glad_gl_has_extension(exts, exts_i, "GL_ARB_texture_mirrored_repeat");
    context->ARB_texture_multisample = glad_gl_has_extension(exts, exts_i, "GL_ARB_texture_multisample");
    context->ARB_texture_non_power_of_two = glad_gl_has_extension(exts, exts_i, "GL_ARB_texture_non_power_of_two");
    context->ARB_texture_query_levels = glad_gl_has_extension(exts, exts_i, "GL_ARB_texture_query_levels");
    context->ARB_texture_query_lod = glad_gl_has_extension(exts, exts_i, "GL_ARB_texture_query_lod");
    context->ARB_texture_rectangle = glad_gl_has_extension(exts, exts_i, "GL_ARB_texture_rectangle");
    context->ARB_texture_rg = glad_gl_has_extension(exts, exts_i, "GL_ARB_texture_rg");
    context->ARB_texture_rgb10_a2ui = glad_gl_has_extension(exts, exts_i, "GL_ARB_texture_rgb10_a2ui");
    context->ARB_texture_stencil8 = glad_gl_has_extension(exts, exts_i, "GL_ARB_texture_stencil8");
    ...
    context->ARB_texture_swizzle = glad_gl_has_extension(exts, exts_i, "GL_ARB_texture_swizzle");
    ...
    context->ARB_transform_feedback_overflow_query = glad_gl_has_extension(exts, exts_i, "GL_ARB_transform_feedback_overflow_query");
    context->ARB_transpose_matrix = glad_gl_has_extension(exts, exts_i, "GL_ARB_transpose_matrix");
    context->ARB_uniform_buffer_object = glad_gl_has_extension(exts, exts_i, "GL_ARB_uniform_buffer_object");
    context->ARB_vertex_array_bgra = glad_gl_has_extension(exts, exts_i, "GL_ARB_vertex_array_bgra");
    ...
    context->ARB_vertex_blend = glad_gl_has_extension(exts, exts_i, "GL_ARB_vertex_blend");
    ...
    context->ARB_vertex_type_10f_11f_11f_rev = glad_gl_has_extension(exts, exts_i, "GL_ARB_vertex_type_10f_11f_11f_rev");
    ...
    context->ARB_window_pos = glad_gl_has_extension(exts, exts_i, "GL_ARB_window_pos");
    context->ATI_draw_buffers = glad_gl_has_extension(exts, exts_i, "GL_ATI_draw_buffers");
    context->ATI_element_array = glad_gl_has_extension(exts, exts_i, "GL_ATI_element_array");
    context->ATI_envmap_bumpmap = glad_gl_has_extension(exts, exts_i, "GL_ATI_envmap_bumpmap");
    context->ATI_fragment_shader = glad_gl_has_extension(exts, exts_i, "GL_ATI_fragment_shader");
    context->ATI_map_object_buffer = glad_gl_has_extension(exts, exts_i, "GL_ATI_map_object_buffer");
    context->ATI_meminfo = glad_gl_has_extension(exts, exts_i, "GL_ATI_meminfo");
    context->ATI_pixel_format_float = glad_gl_has_extension(exts, exts_i, "GL_ATI_pixel_format_float");
    context->ATI_pn_triangles = glad_gl_has_extension(exts, exts_i, "GL_ATI_pn_triangles");
    context->ATI_separate_stencil = glad_gl_has_extension(exts, exts_i, "GL_ATI_separate_stencil");
    context->ATI_text_fragment_shader = glad_gl_has_extension(exts, exts_i, "GL_ATI_text_fragment_shader");
    context->ATI_texture_env_combine3 = glad_gl_has_extension(exts, exts_i, "GL_ATI_texture_env_combine3");
    context->ATI_texture_float = glad_gl_has_extension(exts, exts_i, "GL_ATI_texture_float");
    context->ATI_texture_mirror_once = glad_gl_has_extension(exts, exts_i, "GL_ATI_texture_mirror_once");
    context->ATI_vertex_array_object = glad_gl_has_extension(exts, exts_i, "GL_ATI_vertex_array_object");
    context->ATI_vertex_attrib_array_object = glad_gl_has_extension(exts, exts_i, "GL_ATI_vertex_attrib_array_object");
    context->ATI_vertex_streams = glad_gl_has_extension(exts, exts_i, "GL_ATI_vertex_streams");
    context->EXT_422_pixels = glad_gl_has_extension(exts, exts_i, "GL_EXT_422_pixels");
    context->EXT_EGL_image_storage = glad_gl_has_extension(exts, exts_i, "GL_EXT_EGL_image_storage");
    context->EXT_EGL_sync = glad_gl_has_extension(exts, exts_i, "GL_EXT_EGL_sync");
    context->EXT_abgr = glad_gl_has_extension(exts, exts_i, "GL_EXT_abgr");
    context->EXT_bgra = glad_gl_has_extension(exts, exts_i, "GL_EXT_bgra");
    context->EXT_bindable_uniform = glad_gl_has_extension(exts, exts_i, "GL_EXT_bindable_uniform");
    ...
    context->EXT_blend_logic_op = glad_gl_has_extension(exts, exts_i, "GL_EXT_blend_logic_op");
    context->EXT_blend_minmax = glad_gl_has_extension(exts, exts_i, "GL_EXT_blend_minmax");
    context->EXT_blend_subtract = glad_gl_has_extension(exts, exts_i, "GL_EXT_blend_subtract");
    context->EXT_clip_volume_hint = glad_gl_has_extension(exts, exts_i, "GL_EXT_clip_volume_hint");
    context->EXT_cmyka = glad_gl_has_extension(exts, exts_i, "GL_EXT_cmyka");
    context->EXT_color_subtable = glad_gl_has_extension(exts, exts_i, "GL_EXT_color_subtable");
    context->EXT_compiled_vertex_array = glad_gl_has_extension(exts, exts_i, "GL_EXT_compiled_vertex_array");
    context->EXT_convolution = glad_gl_has_extension(exts, exts_i, "GL_EXT_convolution");
    context->EXT_coordinate_frame = glad_gl_has_extension(exts, exts_i, "GL_EXT_coordinate_frame");
    context->EXT_copy_texture = glad_gl_has_extension(exts, exts_i, "GL_EXT_copy_texture");
    context->EXT_cull_vertex = glad_gl_has_extension(exts, exts_i, "GL_EXT_cull_vertex");
    ...
    context->EXT_depth_bounds_test = glad_gl_has_extension(exts, exts_i, "GL_EXT_depth_bounds_test");
    ...
    context->EXT_framebuffer_multisample_blit_scaled = glad_gl_has_extension(exts, exts_i, "GL_EXT_framebuffer_multisample_blit_scaled");
    context->EXT_framebuffer_object = glad_gl_has_extension(exts, exts_i, "GL_EXT_framebuffer_object");
    context->EXT_framebuffer_sRGB = glad_gl_has_extension(exts, exts_i, "GL_EXT_framebuffer_sRGB");
    context->EXT_geometry_shader4 = glad_gl_has_extension(exts, exts_i, "GL_EXT_geometry_shader4");
    context->EXT_gpu_program_parameters = glad_gl_has_extension(exts, exts_i, "GL_EXT_gpu_program_parameters");
    context->EXT_gpu_shader4 = glad_gl_has_extension(exts, exts_i, "GL_EXT_gpu_shader4");
    context->EXT_histogram = glad_gl_has_extension(exts, exts_i, "GL_EXT_histogram");
    context->EXT_index_array_formats = glad_gl_has_extension(exts, exts_i, "GL_EXT_index_array_formats");
    context->EXT_index_func = glad_gl_has_extension(exts, exts_i, "GL_EXT_index_func");
    context->EXT_index_material = glad_gl_has_extension(exts, exts_i, "GL_EXT_index_material");
    context->EXT_index_texture = glad_gl_has_extension(exts, exts_i, "GL_EXT_index_texture");
    context->EXT_light_texture = glad_gl_has_extension(exts, exts_i, "GL_EXT_light_texture");
    ...
    context->EXT_packed_depth_stencil = glad_gl_has_extension(exts, exts_i, "GL_EXT_packed_depth_stencil");
    context->EXT_packed_float = glad_gl_has_extension(exts, exts_i, "GL_EXT_packed_float");
    context->EXT_packed_pixels = glad_gl_has_extension(exts, exts_i, "GL_EXT_packed_pixels");
    context->EXT_paletted_texture = glad_gl_has_extension(exts, exts_i, "GL_EXT_paletted_texture");
    context->EXT_pixel_buffer_object = glad_gl_has_extension(exts, exts_i, "GL_EXT_pixel_buffer_object");
    context->EXT_pixel_transform = glad_gl_has_extension(exts, exts_i, "GL_EXT_pixel_transform");
    context->EXT_pixel_transform_color_table = glad_gl_has_extension(exts, exts_i, "GL_EXT_pixel_transform_color_table");
    context->EXT_point_parameters = glad_gl_has_extension(exts, exts_i, "GL_EXT_point_parameters");
    context->EXT_polygon_offset = glad_gl_has_extension(exts, exts_i, "GL_EXT_polygon_offset");
    ...
    context->EXT_rescale_normal = glad_gl_has_extension(exts, exts_i, "GL_EXT_rescale_normal");
    context->EXT_secondary_color = glad_gl_has_extension(exts, exts_i, "GL_EXT_secondary_color");
    ...
    context->EXT_separate_specular_color = glad_gl_has_extension(exts, exts_i, "GL_EXT_separate_specular_color");
    ...
    context->EXT_shader_image_load_formatted = glad_gl_has_extension(exts, exts_i, "GL_EXT_shader_image_load_formatted");
    ...
    context->EXT_shadow_funcs = glad_gl_has_extension(exts, exts_i, "GL_EXT_shadow_funcs");
    context->EXT_shared_texture_palette = glad_gl_has_extension(exts, exts_i, "GL_EXT_shared_texture_palette");
    context->EXT_sparse_texture2 = glad_gl_has_extension(exts, exts_i, "GL_EXT_sparse_texture2");
    context->EXT_stencil_clear_tag = glad_gl_has_extension(exts, exts_i, "GL_EXT_stencil_clear_tag");
    context->EXT_stencil_two_side = glad_gl_has_extension(exts, exts_i, "GL_EXT_stencil_two_side");
    context->EXT_stencil_wrap = glad_gl_has_extension(exts, exts_i, "GL_EXT_stencil_wrap");
    context->EXT_subtexture = glad_gl_has_extension(exts, exts_i, "GL_EXT_subtexture");
    context->EXT_texture = glad_gl_has_extension(exts, exts_i, "GL_EXT_texture");
    ...
    context->EXT_texture_compression_latc = glad_gl_has_extension(exts, exts_i, "GL_EXT_texture_compression_latc");
    ...
    context->EXT_texture_cube_map = glad_gl_has_extension(exts, exts_i, "GL_EXT_texture_cube_map");
    context->EXT_texture_env_add = glad_gl_has_extension(exts, exts_i, "GL_EXT_texture_env_add");
    context->EXT_texture_env_combine = glad_gl_has_extension(exts, exts_i, "GL_EXT_texture_env_combine");
    context->EXT_texture_env_dot3 = glad_gl_has_extension(exts, exts_i, "GL_EXT_texture_env_dot3");
    ...
    context->EXT_texture_mirror_clamp = glad_gl_has_extension(exts, exts_i, "GL_EXT_texture_mirror_clamp");
    context->EXT_texture_object = glad_gl_has_extension(exts, exts_i, "GL_EXT_texture_object");
    context->EXT_texture_perturb_normal = glad_gl_has_extension(exts, exts_i, "GL_EXT_texture_perturb_normal");
    context->EXT_texture_sRGB = glad_gl_has_extension(exts, exts_i, "GL_EXT_texture_sRGB");
    ...
    context->EXT_texture_shared_exponent = glad_gl_has_extension(exts, exts_i, "GL_EXT_texture_shared_exponent");
    context->EXT_texture_snorm = glad_gl_has_extension(exts, exts_i, "GL_EXT_texture_snorm");
    context->EXT_texture_storage = glad_gl_has_extension(exts, exts_i, "GL_EXT_texture_storage");
    context->EXT_texture_swizzle = glad_gl_has_extension(exts, exts_i, "GL_EXT_texture_swizzle");
    ...
    context->EXT_vertex_array_bgra = glad_gl_has_extension(exts, exts_i, "GL_EXT_vertex_array_bgra");
    context->EXT_vertex_attrib_64bit = glad_gl_has_extension(exts, exts_i, "GL_EXT_vertex_attrib_64bit");
    context->EXT_vertex_shader = glad_gl_has_extension(exts, exts_i, "GL_EXT_vertex_shader");
    context->EXT_vertex_weighting = glad_gl_has_extension(exts, exts_i, "GL_EXT_vertex_weighting");
    ...
    context->EXT_x11_sync_object = glad_gl_has_extension(exts, exts_i, "GL_EXT_x11_sync_object");
    context->GREMEDY_frame_terminator = glad_gl_has_extension(exts, exts_i, "GL_GREMEDY_frame_terminator");
    context->GREMEDY_string_marker = glad_gl_has_extension(exts, exts_i, "GL_GREMEDY_string_marker");
    context->HP_convolution_border_modes = glad_gl_has_extension(exts, exts_i, "GL_HP_convolution_border_modes");
    context->HP_image_transform = glad_gl_has_extension(exts, exts_i, "GL_HP_image_transform");
    context->HP_occlusion_test = glad_gl_has_extension(exts, exts_i, "GL_HP_occlusion_test");
    context->HP_texture_lighting = glad_gl_has_extension(exts, exts_i, "GL_HP_texture_lighting");
    context->IBM_cull_vertex = glad_gl_has_extension(exts, exts_i, "GL_IBM_cull_vertex");
    context->IBM_multimode_draw_arrays = glad_gl_has_extension(exts, exts_i, "GL_IBM_multimode_draw_arrays");
    context->IBM_rasterpos_clip = glad_gl_has_extension(exts, exts_i, "GL_IBM_rasterpos_clip");
    context->IBM_static_data = glad_gl_has_extension(exts, exts_i, "GL_IBM_static_data");
    context->IBM_texture_mirrored_repeat = glad_gl_has_extension(exts, exts_i, "GL_IBM_texture_mirrored_repeat");
    context->IBM_vertex_array_lists = glad_gl_has_extension(exts, exts_i, "GL_IBM_vertex_array_lists");
    context->INGR_blend_func_separate = glad_gl_has_extension(exts, exts_i, "GL_INGR_blend_func_separate");
    context->INGR_color_clamp = glad_gl_has_extension(exts, exts_i, "GL_INGR_color_clamp");
    context->INGR_interlace_read = glad_gl_has_extension(exts, exts_i, "GL_INGR_interlace_read");
    ...
    context->INTEL_fragment_shader_ordering = glad_gl_has_extension(exts, exts_i, "GL_INTEL_fragment_shader_ordering");
    context->INTEL_framebuffer_CMAA = glad_gl_has_extension(exts, exts_i, "GL_INTEL_framebuffer_CMAA");
    context->INTEL_map_texture = glad_gl_has_extension(exts, exts_i, "GL_INTEL_map_texture");
    context->INTEL_parallel_arrays = glad_gl_has_extension(exts, exts_i, "GL_INTEL_parallel_arrays");
    ...
    context->MESAX_texture_stack = glad_gl_has_extension(exts, exts_i, "GL_MESAX_texture_stack");
    ...
    context->MESA_pack_invert = glad_gl_has_extension(exts, exts_i, "GL_MESA_pack_invert");
    context->MESA_program_binary_formats = glad_gl_has_extension(exts, exts_i, "GL_MESA_program_binary_formats");
    context->MESA_resize_buffers = glad_gl_has_extension(exts, exts_i, "GL_MESA_resize_buffers");
    ...
    context->MESA_tile_raster_order = glad_gl_has_extension(exts, exts_i, "GL_MESA_tile_raster_order");
    context->MESA_window_pos = glad_gl_has_extension(exts, exts_i, "GL_MESA_window_pos");
    context->MESA_ycbcr_texture = glad_gl_has_extension(exts, exts_i, "GL_MESA_ycbcr_texture");
    ...
    context->NVX_gpu_memory_info = glad_gl_has_extension(exts, exts_i, "GL_NVX_gpu_memory_info");
    context->NVX_gpu_multicast2 = glad_gl_has_extension(exts, exts_i, "GL_NVX_gpu_multicast2");
    context->NVX_linked_gpu_multicast = glad_gl_has_extension(exts, exts_i, "GL_NVX_linked_gpu_multicast");
    context->NVX_progress_fence = glad_gl_has_extension(exts, exts_i, "GL_NVX_progress_fence");
    context->NV_alpha_to_coverage_dither_control = glad_gl_has_extension(exts, exts_i, "GL_NV_alpha_to_coverage_dither_control");
    context->NV_bindless_multi_draw_indirect = glad_gl_has_extension(exts, exts_i, "GL_NV_bindless_multi_draw_indirect");
    context->NV_bindless_multi_draw_indirect_count = glad_gl_has_extension(exts, exts_i, "GL_NV_bindless_multi_draw_indirect_count");
    ...
    context->NV_blend_square = glad_gl_has_extension(exts, exts_i, "GL_NV_blend_square");
    context->NV_clip_space_w_scaling = glad_gl_has_extension(exts, exts_i, "GL_NV_clip_space_w_scaling");
    context->NV_command_list = glad_gl_has_extension(exts, exts_i, "GL_NV_command_list");
    context->NV_compute_program5 = glad_gl_has_extension(exts, exts_i, "GL_NV_compute_program5");
    ...
    context->NV_conservative_raster_dilate = glad_gl_has_extension(exts, exts_i, "GL_NV_conservative_raster_dilate");
    ...
    context->NV_conservative_raster_underestimation = glad_gl_has_extension(exts, exts_i, "GL_NV_conservative_raster_underestimation");
    context->NV_copy_depth_to_color = glad_gl_has_extension(exts, exts_i, "GL_NV_copy_depth_to_color");
    context->NV_copy_image = glad_gl_has_extension(exts, exts_i, "GL_NV_copy_image");
    context->NV_deep_texture3D = glad_gl_has_extension(exts, exts_i, "GL_NV_deep_texture3D");
    context->NV_depth_buffer_float = glad_gl_has_extension(exts, exts_i, "GL_NV_depth_buffer_float");
    context->NV_depth_clamp = glad_gl_has_extension(exts, exts_i, "GL_NV_depth_clamp");
    context->NV_draw_texture = glad_gl_has_extension(exts, exts_i, "GL_NV_draw_texture");
    context->NV_draw_vulkan_image = glad_gl_has_extension(exts, exts_i, "GL_NV_draw_vulkan_image");
    context->NV_evaluators = glad_gl_has_extension(exts, exts_i, "GL_NV_evaluators");
    ...
    context->NV_float_buffer = glad_gl_has_extension(exts, exts_i, "GL_NV_float_buffer");
    context->NV_fog_distance = glad_gl_has_extension(exts, exts_i, "GL_NV_fog_distance");
    context->NV_fragment_coverage_to_color = glad_gl_has_extension(exts, exts_i, "GL_NV_fragment_coverage_to_color");
    context->NV_fragment_program = glad_gl_has_extension(exts, exts_i, "GL_NV_fragment_program");
    context->NV_fragment_program2 = glad_gl_has_extension(exts, exts_i, "GL_NV_fragment_program2");
    context->NV_fragment_program4 = glad_gl_has_extension(exts, exts_i, "GL_NV_fragment_program4");
    context->NV_fragment_program_option = glad_gl_has_extension(exts, exts_i, "GL_NV_fragment_program_option");
    ...
    context->NV_framebuffer_multisample_coverage = glad_gl_has_extension(exts, exts_i, "GL_NV_framebuffer_multisample_coverage");
    context->NV_geometry_program4 = glad_gl_has_extension(exts, exts_i, "GL_NV_geometry_program4");
    context->NV_geometry_shader4 = glad_gl_has_extension(exts, exts_i, "GL_NV_geometry_shader4");
    context->NV_geometry_shader_passthrough = glad_gl_has_extension(exts, exts_i, "GL_NV_geometry_shader_passthrough");
    context->NV_gpu_multicast = glad_gl_has_extension(exts, exts_i, "GL_NV_gpu_multicast");
    context->NV_gpu_program4 = glad_gl_has_extension(exts, exts_i, "GL_NV_gpu_program4");
    context->NV_gpu_program5 = glad_gl_has_extension(exts, exts_i, "GL_NV_gpu_program5");
    context->NV_gpu_program5_mem_extended = glad_gl_has_extension(exts, exts_i, "GL_NV_gpu_program5_mem_extended");
    context->NV_gpu_shader5 = glad_gl_has_extension(exts, exts_i, "GL_NV_gpu_shader5");
    context->NV_half_float = glad_gl_has_extension(exts, exts_i, "GL_NV_half_float");
    context->NV_internalformat_sample_query = glad_gl_has_extension(exts, exts_i, "GL_NV_internalformat_sample_query");
    context->NV_light_max_exponent = glad_gl_has_extension(exts, exts_i, "GL_NV_light_max_exponent");
    ...
    context->NV_multisample_coverage = glad_gl_has_extension(exts, exts_i, "GL_NV_multisample_coverage");
    context->NV_multisample_filter_hint = glad_gl_has_extension(exts, exts_i, "GL_NV_multisample_filter_hint");
    context->NV_occlusion_query = glad_gl_has_extension(exts, exts_i, "GL_NV_occlusion_query");
    context->NV_packed_depth_stencil = glad_gl_has_extension(exts, exts_i, "GL_NV_packed_depth_stencil");
    context->NV_parameter_buffer_object = glad_gl_has_extension(exts, exts_i, "GL_NV_parameter_buffer_object");
    context->NV_parameter_buffer_object2 = glad_gl_has_extension(exts, exts_i, "GL_NV_parameter_buffer_object2");
    ...
    context->NV_pixel_data_range = glad_gl_has_extension(exts, exts_i, "GL_NV_pixel_data_range");
    context->NV_point_sprite = glad_gl_has_extension(exts, exts_i, "GL_NV_point_sprite");
    context->NV_present_video = glad_gl_has_extension(exts, exts_i, "GL_NV_present_video");
    context->NV_primitive_restart = glad_gl_has_extension(exts, exts_i, "GL_NV_primitive_restart");
    context->NV_primitive_shading_rate = glad_gl_has_extension(exts, exts_i, "GL_NV_primitive_shading_rate");
    context->NV_query_resource = glad_gl_has_extension(exts, exts_i, "GL_NV_query_resource");
    context->NV_query_resource_tag = glad_gl_has_extension(exts, exts_i, "GL_NV_query_resource_tag");
    context->NV_register_combiners = glad_gl_has_extension(exts, exts_i, "GL_NV_register_combiners");
    context->NV_register_combiners2 = glad_gl_has_extension(exts, exts_i, "GL_NV_register_combiners2");
    context->NV_representative_fragment_test = glad_gl_has_extension(exts, exts_i, "GL_NV_representative_fragment_test");
    context->NV_robustness_video_memory_purge = glad_gl_has_extension(exts, exts_i, "GL_NV_robustness_video_memory_purge");
    ...
    context->NV_shader_atomic_counters = glad_gl_has_extension(exts, exts_i, "GL_NV_shader_atomic_counters");
    context->NV_shader_atomic_float = glad_gl_has_extension(exts, exts_i, "GL_NV_shader_atomic_float");
    context->NV_shader_atomic_float64 = glad_gl_has_extension(exts, exts_i, "GL_NV_shader_atomic_float64");
    context->NV_shader_atomic_fp16_vector = glad_gl_has_extension(exts, exts_i, "GL_NV_shader_atomic_fp16_vector");
    context->NV_shader_atomic_int64 = glad_gl_has_extension(exts, exts_i, "GL_NV_shader_atomic_int64");
    context->NV_shader_buffer_load = glad_gl_has_extension(exts, exts_i, "GL_NV_shader_buffer_load");
    context->NV_shader_buffer_store = glad_gl_has_extension(exts, exts_i, "GL_NV_shader_buffer_store");
    context->NV_shader_storage_buffer_object = glad_gl_has_extension(exts, exts_i, "GL_NV_shader_storage_buffer_object");
    ...
    context->NV_shader_thread_group = glad_gl_has_extension(exts, exts_i, "GL_NV_shader_thread_group");
    context->NV_shader_thread_shuffle = glad_gl_has_extension(exts, exts_i, "GL_NV_shader_thread_shuffle");
    ...
    context->NV_tessellation_program5 = glad_gl_has_extension(exts, exts_i, "GL_NV_tessellation_program5");
    context->NV_texgen_emboss = glad_gl_has_extension(exts, exts_i, "GL_NV_texgen_emboss");
    context->NV_texgen_reflection = glad_gl_has_extension(exts, exts_i, "GL_NV_texgen_reflection");
    context->NV_texture_barrier = glad_gl_has_extension(exts, exts_i, "GL_NV_texture_barrier");
    context->NV_texture_compression_vtc = glad_gl_has_extension(exts, exts_i, "GL_NV_texture_compression_vtc");
    context->NV_texture_env_combine4 = glad_gl_has_extension(exts, exts_i, "GL_NV_texture_env_combine4");
    context->NV_texture_expand_normal = glad_gl_has_extension(exts, exts_i, "GL_NV_texture_expand_normal");
    context->NV_texture_multisample = glad_gl_has_extension(exts, exts_i, "GL_NV_texture_multisample");
    context->NV_texture_rectangle = glad_gl_has_extension(exts, exts_i, "GL_NV_texture_rectangle");
    context->NV_texture_rectangle_compressed = glad_gl_has_extension(exts, exts_i, "GL_NV_texture_rectangle_compressed");
    context->NV_texture_shader = glad_gl_has_extension(exts, exts_i, "GL_NV_texture_shader");
    context->NV_texture_shader2 = glad_gl_has_extension(exts, exts_i, "GL_NV_texture_shader2");
    context->NV_texture_shader3 = glad_gl_has_extension(exts, exts_i, "GL_NV_texture_shader3");
    ...
    context->NV_uniform_buffer_std430_layout = glad_gl_has_extension(exts, exts_i, "GL_NV_uniform_buffer_std430_layout");
    context->NV_uniform_buffer_unified_memory = glad_gl_has_extension(exts, exts_i, "GL_NV_uniform_buffer_unified_memory");
    context->NV_vdpau_interop = glad_gl_has_extension(exts, exts_i, "GL_NV_vdpau_interop");
    context->NV_vdpau_interop2 = glad_gl_has_extension(exts, exts_i, "GL_NV_vdpau_interop2");
    context->NV_vertex_array_range = glad_gl_has_extension(exts, exts_i, "GL_NV_vertex_array_range");
    context->NV_vertex_array_range2 = glad_gl_has_extension(exts, exts_i, "GL_NV_vertex_array_range2");
    context->NV_vertex_attrib_integer_64bit = glad_gl_has_extension(exts, exts_i, "GL_NV_vertex_attrib_integer_64bit");
    context->NV_vertex_buffer_unified_memory = glad_gl_has_extension(exts, exts_i, "GL_NV_vertex_buffer_unified_memory");
    context->NV_vertex_program = glad_gl_has_extension(exts, exts_i, "GL_NV_vertex_program");
    context->NV_vertex_program1_1 = glad_gl_has_extension(exts, exts_i, "GL_NV_vertex_program1_1");
    context->NV_vertex_program2 = glad_gl_has_extension(exts, exts_i, "GL_NV_vertex_program2");
    context->NV_vertex_program2_option = glad_gl_has_extension(exts, exts_i, "GL_NV_vertex_program2_option");
    context->NV_vertex_program3 = glad_gl_has_extension(exts, exts_i, "GL_NV_vertex_program3");
    context->NV_vertex_program4 = glad_gl_has_extension(exts, exts_i, "GL_NV_vertex_program4");
    context->NV_video_capture = glad_gl_has_extension(exts, exts_i, "GL_NV_video_capture");
    ...
    context->OML_interlace = glad_gl_has_extension(exts, exts_i, "GL_OML_interlace");
    context->OML_resample = glad_gl_has_extension(exts, exts_i, "GL_OML_resample");
    context->OML_subsample = glad_gl_has_extension(exts, exts_i, "GL_OML_subsample");
    ...
    context->PGI_misc_hints = glad_gl_has_extension(exts, exts_i, "GL_PGI_misc_hints");
    context->PGI_vertex_hints = glad_gl_has_extension(exts, exts_i, "GL_PGI_vertex_hints");
    context->REND_screen_coordinates = glad_gl_has_extension(exts, exts_i, "GL_REND_screen_coordinates");
    context->S3_s3tc = glad_gl_has_extension(exts, exts_i, "GL_S3_s3tc");
    context->SGIS_detail_texture = glad_gl_has_extension(exts, exts_i, "GL_SGIS_detail_texture");
    context->SGIS_fog_function = glad_gl_has_extension(exts, exts_i, "GL_SGIS_fog_function");
    context->SGIS_generate_mipmap = glad_gl_has_extension(exts, exts_i, "GL_SGIS_generate_mipmap");
    context->SGIS_multisample = glad_gl_has_extension(exts, exts_i, "GL_SGIS_multisample");
    context->SGIS_pixel_texture = glad_gl_has_extension(exts, exts_i, "GL_SGIS_pixel_texture");
    context->SGIS_point_line_texgen = glad_gl_has_extension(exts, exts_i, "GL_SGIS_point_line_texgen");
    context->SGIS_point_parameters = glad_gl_has_extension(exts, exts_i, "GL_SGIS_point_parameters");
    context->SGIS_sharpen_texture = glad_gl_has_extension(exts, exts_i, "GL_SGIS_sharpen_texture");
    context->SGIS_texture4D = glad_gl_has_extension(exts, exts_i, "GL_SGIS_texture4D");
    context->SGIS_texture_border_clamp = glad_gl_has_extension(exts, exts_i, "GL_SGIS_texture_border_clamp");
    context->SGIS_texture_color_mask = glad_gl_has_extension(exts, exts_i, "GL_SGIS_texture_color_mask");
    context->SGIS_texture_edge_clamp = glad_gl_has_extension(exts, exts_i, "GL_SGIS_texture_edge_clamp");
    context->SGIS_texture_filter4 = glad_gl_has_extension(exts, exts_i, "GL_SGIS_texture_filter4");
    context->SGIS_texture_lod = glad_gl_has_extension(exts, exts_i, "GL_SGIS_texture_lod");
    context->SGIS_texture_select = glad_gl_has_extension(exts, exts_i, "GL_SGIS_texture_select");
    context->SGIX_async = glad_gl_has_extension(exts, exts_i, "GL_SGIX_async");
    context->SGIX_async_histogram = glad_gl_has_extension(exts, exts_i, "GL_SGIX_async_histogram");
    context->SGIX_async_pixel = glad_gl_has_extension(exts, exts_i, "GL_SGIX_async_pixel");
    context->SGIX_blend_alpha_minmax = glad_gl_has_extension(exts, exts_i, "GL_SGIX_blend_alpha_minmax");
    context->SGIX_calligraphic_fragment = glad_gl_has_extension(exts, exts_i, "GL_SGIX_calligraphic_fragment");
    context->SGIX_clipmap = glad_gl_has_extension(exts, exts_i, "GL_SGIX_clipmap");
    context->SGIX_convolution_accuracy = glad_gl_has_extension(exts, exts_i, "GL_SGIX_convolution_accuracy");
    context->SGIX_depth_pass_instrument = glad_gl_has_extension(exts, exts_i, "GL_SGIX_depth_pass_instrument");
    context->SGIX_depth_texture = glad_gl_has_extension(exts, exts_i, "GL_SGIX_depth_texture");
    context->SGIX_flush_raster = glad_gl_has_extension(exts, exts_i, "GL_SGIX_flush_raster");
    context->SGIX_fog_offset = glad_gl_has_extension(exts, exts_i, "GL_SGIX_fog_offset");
    context->SGIX_fragment_lighting = glad_gl_has_extension(exts, exts_i, "GL_SGIX_fragment_lighting");
    context->SGIX_framezoom = glad_gl_has_extension(exts, exts_i, "GL_SGIX_framezoom");
    context->SGIX_igloo_interface = glad_gl_has_extension(exts, exts_i, "GL_SGIX_igloo_interface");
    context->SGIX_instruments = glad_gl_has_extension(exts, exts_i, "GL_SGIX_instruments");
    context->SGIX_interlace = glad_gl_has_extension(exts, exts_i, "GL_SGIX_interlace");
    context->SGIX_ir_instrument1 = glad_gl_has_extension(exts, exts_i, "GL_SGIX_ir_instrument1");
    context->SGIX_list_priority = glad_gl_has_extension(exts, exts_i, "GL_SGIX_list_priority");
    context->SGIX_pixel_texture = glad_gl_has_extension(exts, exts_i, "GL_SGIX_pixel_texture");
    context->SGIX_pixel_tiles = glad_gl_has_extension(exts, exts_i, "GL_SGIX_pixel_tiles");
    context->SGIX_polynomial_ffd = glad_gl_has_extension(exts, exts_i, "GL_SGIX_polynomial_ffd");
    context->SGIX_reference_plane = glad_gl_has_extension(exts, exts_i, "GL_SGIX_reference_plane");
    context->SGIX_resample = glad_gl_has_extension(exts, exts_i, "GL_SGIX_resample");
    context->SGIX_scalebias_hint = glad_gl_has_extension(exts, exts_i, "GL_SGIX_scalebias_hint");
    context->SGIX_shadow = glad_gl_has_extension(exts, exts_i, "GL_SGIX_shadow");
    context->SGIX_shadow_ambient = glad_gl_has_extension(exts, exts_i, "GL_SGIX_shadow_ambient");
    context->SGIX_sprite = glad_gl_has_extension(exts, exts_i, "GL_SGIX_sprite");
    context->SGIX_subsample = glad_gl_has_extension(exts, exts_i, "GL_SGIX_subsample");
    context->SGIX_tag_sample_buffer = glad_gl_has_extension(exts, exts_i, "GL_SGIX_tag_sample_buffer");
    context->SGIX_texture_add_env = glad_gl_has_extension(exts, exts_i, "GL_SGIX_texture_add_env");
    context->SGIX_texture_coordinate_clamp = glad_gl_has_extension(exts, exts_i, "GL_SGIX_texture_coordinate_clamp");
    context->SGIX_texture_lod_bias = glad_gl_has_extension(exts, exts_i, "GL_SGIX_texture_lod_bias");
    context->SGIX_texture_multi_buffer = glad_gl_has_extension(exts, exts_i, "GL_SGIX_texture_multi_buffer");
    context->SGIX_texture_scale_bias = glad_gl_has_extension(exts, exts_i, "GL_SGIX_texture_scale_bias");
    context->SGIX_vertex_preclip = glad_gl_has_extension(exts, exts_i, "GL_SGIX_vertex_preclip");
    context->SGIX_ycrcb = glad_gl_has_extension(exts, exts_i, "GL_SGIX_ycrcb");
    context->SGIX_ycrcb_subsample = glad_gl_has_extension(exts, exts_i, "GL_SGIX_ycrcb_subsample");
    context->SGIX_ycrcba = glad_gl_has_extension(exts, exts_i, "GL_SGIX_ycrcba");
    context->SGI_color_matrix = glad_gl_has_extension(exts, exts_i, "GL_SGI_color_matrix");
    context->SGI_color_table = glad_gl_has_extension(exts, exts_i, "GL_SGI_color_table");
    context->SGI_texture_color_table = glad_gl_has_extension(exts, exts_i, "GL_SGI_texture_color_table");
    context->SUNX_constant_data = glad_gl_has_extension(exts, exts_i, "GL_SUNX_constant_data");
    context->SUN_convolution_border_modes = glad_gl_has_extension(exts, exts_i, "GL_SUN_convolution_border_modes");
    context->SUN_global_alpha = glad_gl_has_extension(exts, exts_i, "GL_SUN_global_alpha");
    context->SUN_mesh_array = glad_gl_has_extension(exts, exts_i, "GL_SUN_mesh_array");
    context->SUN_slice_accum = glad_gl_has_extension(exts, exts_i, "GL_SUN_slice_accum");
    context->SUN_triangle_list = glad_gl_has_extension(exts, exts_i, "GL_SUN_triangle_list");
    context->SUN_vertex = glad_gl_has_extension(exts, exts_i, "GL_SUN_vertex");
    context->WIN_phong_shading = glad_gl_has_extension(exts, exts_i, "GL_WIN_phong_shading");
    context->WIN_specular_fog = glad_gl_has_extension(exts, exts_i, "GL_WIN_specular_fog");
