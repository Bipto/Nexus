...
namespace Nexus::Graphics
{
    ...
    /// @brief A structure representing the specific version of a shader language
    /// that should be used as input/targetted for output of the compilation (e.g.
    /// GLSL 450 would be 4.5 in this format)
    ...
    inline bool IsBinaryShaderFormat(ShaderLanguage language)
    {
        ...
        case ShaderLanguage::OpenGL_SPIRV:
            return true;
        default:
            return false;
        }
