...
namespace Nexus::Graphics
{
    ...
    struct GraphicsPipelineDescription
    {
        ...
        /// @brief An array containing the colour formats that will be used with the
        /// pipeline
        std::array<PixelFormat, 8> ColourFormats;

        /// @brief An unsigned 32 bit integer representing the number of attachments
        /// that will be used with the pipeline
        uint32_t ColourTargetCount = 1;

        /// @brief An array containing the blend state for each attachment to be used
        /// with the pipelin
        ...
        /// @brief The tesselation evaluation shader to use with the pipeline
        /// (optional)
