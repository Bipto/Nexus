...
namespace Nexus::Graphics
{
    ...
    {
        /// @brief The buffer memory is accessible to the CPU and GPU and is
        /// optimized for transferring from CPU to GPU. Can also be used to read back
        /// data, although this may not be as optimized as with Readback.
        Upload,

        /// @brief The buffer memory is resident on the GPU and is inaccessible to
        /// the CPU. Recommended for most resources.
        Default,

        /// @brief The buffer memory is accessible to the CPU and GPU, however it is
        /// an error to attempt to write to this memory with the CPU.
        Readback
    };
