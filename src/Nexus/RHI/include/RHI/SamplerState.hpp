...
namespace Nexus::Graphics
{
    ...
    enum SamplerState
    {
        ...
        /// @brief Pixels will be clamped to the nearest value and pixels out of
        /// range will be clamped to the nearest value in the texture
        PointClamp,

        /// @brief Pixels will be clamped to the nearest value and pixels out of
        /// range will be wrapped around into the texture
        PointWrap
    };
