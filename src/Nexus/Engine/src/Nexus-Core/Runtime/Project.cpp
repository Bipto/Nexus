...
namespace Nexus
{
        ...
        if (m_Library)
        {
            ...
            if (func)
            {
                ...
                Nexus::ImGuiUtils::ImGuiGraphicsRenderer *imGuiRenderer =
                    Nexus::ImGuiUtils::ImGuiGraphicsRenderer::GetCurrentRenderer();
                if (imGuiRenderer)
                {
    ...
    Project::LoadAvailableScripts()
    {
        ...
        if (m_Library)
        {
            ...
            if (func)
            {
                ...
                for (const auto &[name, creationFunc] : loadedScripts)
                {
                    scripts[name] = creationFunc;
                }
            }
        }
    ...
    void Project::CacheAvailableScripts()
    {
        ...
        for (const auto &[name, creationFunc] : scripts)
        {
            m_AvailableScripts.push_back(name);
        }
    }
    ...
    void Project::LoadAvailableAssetProcessors()
    {
        ...
        if (m_Library)
        {
            ...
            if (func)
            {
                ...
                for (const auto &[name, processorInfo] : loadedProcessors)
                {
                    processors[name] = processorInfo;
                }
            }
        }
