...
namespace Nexus::Graphics
{
    ...
    static ReflectedShaderDataType ExtractComponentType(D3D_REGISTER_COMPONENT_TYPE componentType, UINT componentCount)
    {
        ...
        default:
            throw std::runtime_error("Failed to find valid register component type");
        }
    }
    ...
    static ResourceDimension ExtractDimension(D3D_SRV_DIMENSION dimension)
    {
        ...
        case D3D_SRV_DIMENSION_TEXTURE1DARRAY:
            return ResourceDimension::Texture1DArray;
        case D3D_SRV_DIMENSION_TEXTURE2D:
            return ResourceDimension::Texture2D;
        case D3D_SRV_DIMENSION_TEXTURE2DARRAY:
            return ResourceDimension::Texture2DArray;
        case D3D_SRV_DIMENSION_TEXTURE2DMS:
            return ResourceDimension::Texture2DMS;
        case D3D_SRV_DIMENSION_TEXTURE2DMSARRAY:
            return ResourceDimension::Texture2DMSArray;
        case D3D_SRV_DIMENSION_TEXTURE3D:
            return ResourceDimension::Texture3D;
        case D3D_SRV_DIMENSION_TEXTURECUBE:
            return ResourceDimension::TextureCube;
        case D3D_SRV_DIMENSION_TEXTURECUBEARRAY:
            return ResourceDimension::TextureCubeArray;
        default:
            return ResourceDimension::NoDimension;
        }
    }
