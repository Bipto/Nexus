...
{
	SurfaceWin32_D3D12::SurfaceWin32_D3D12(uintptr_t hwnd, uintptr_t hdc, uintptr_t hinstance) : m_Hwnd(hwnd), m_Hdc(hdc), m_Hinstance(hinstance)
	{
	}
		...
		IDXGIFactory2			   *factory) const
	{
		...
		HRESULT									hr = factory->CreateSwapChainForHwnd(commandQueue,
