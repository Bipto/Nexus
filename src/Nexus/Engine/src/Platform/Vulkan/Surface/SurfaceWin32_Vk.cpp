...
{
    SurfaceWin32_Vk::SurfaceWin32_Vk(
    ...
    std::expected<VkSurfaceKHR, VkResult> SurfaceWin32_Vk::CreateVkSurface(
    ...
    ) const
    {
        ...
        VkResult result =
            context.CreateWin32SurfaceKHR(instance, &createInfo, nullptr, &surface);
