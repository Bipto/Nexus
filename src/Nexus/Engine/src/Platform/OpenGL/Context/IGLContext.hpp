...
namespace Nexus::GL
{
    class IGLContext
    {
      public:
        ...
        void TexStorage1D(
            GLuint texture, GLenum textureType, GLsizei levels,
        ...
        void TexStorage2DMultisample(
            GLuint texture, GLenum textureType, GLsizei samples,
            GLenum internalformat, GLsizei width, GLsizei height,
        ...
        // texture buffers
        std::expected<uint32_t, std::string> CreateTexelBuffer(
        ...
        // samplers
        virtual std::expected<uint32_t, std::string> CreateSampler(
        ...
        // fences
        std::expected<GLsync, std::string> CreateFence(
        ...
        void SetBlendFunctionSeparatei(
        ...
        void SetBlendEquationSeparatei(
        ...
        int32_t GetProgramResourceIndex(
