...
namespace Nexus::Graphics
{
    ...
    TextureViewOpenGL::TextureViewOpenGL(const TextureViewDescription &desc, GraphicsDeviceOpenGL *device)
    ...
    void TextureViewOpenGL::UpdateEmulatedView(GL::IGLContext *context) const
    {
        ...
        for (uint32_t arrayLayer = m_Description.Range.BaseArrayLayer;
             arrayLayer < m_Description.Range.BaseArrayLayer + m_Description.Range.LayerCount; arrayLayer++)
        {
