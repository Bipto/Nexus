...
namespace Nexus::Graphics
{
    ...
    class NX_API MeshFactory
    {
      public:
        ...
        explicit MeshFactory(IGraphicsDevice *device, CommandQueueHandle commandQueue)
        ...
        /// @brief A method that returns a mesh representing a sprite with a width
        /// and height of 1
        ...
        /// @brief A method that returns a mesh representing a 3D model stored on
        /// disk
