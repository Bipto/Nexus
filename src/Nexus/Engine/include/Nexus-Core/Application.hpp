...
namespace Nexus
{
    ...
    class NX_API Application
    {
      public:
        ...
        /// @brief A virtual destructor allowing derived classes to clean up
        /// resources
        virtual ~Application();

        // required overridable methods
        /// @brief A pure virtual method that is called when the application is
        /// loaded
        virtual void Load() = 0;
        ...
        /// @brief A virtual method that allows a client to block the application
        /// from closing (e.g. to prompt to save)
