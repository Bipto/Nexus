...
namespace Nexus
{
	class NX_API ShaderImporter
	{
	  ...
	  private:
		std::expected<std::string, std::string> PreprocessStep(IResourceLoader				  *loader,
															   const std::string			  &shaderPath,
															   const std::string			  &shaderText,
															   const std::vector<std::string> &shaderIncludeDirectories) const;

		std::expected<ShaderCompilationResult, std::string> CompileTextStep(const std::string						 &shaderText,
																			const ShaderCompilationInputDescription	 &shaderInputDescription,
																			const ShaderCompilationOutputDescription &shaderOutputDescription,
																			Graphics::GraphicsAPIInfo				  environment,
																			Graphics::ShaderStage					  stage,
		...
		std::expected<ShaderCompilationResult, std::string> CompileBinaryStep(std::span<const std::byte>				shaderBinary,
																			  const ShaderCompilationInputDescription  &shaderInputDescription,
																			  const ShaderCompilationOutputDescription &shaderOutputDescription,
																			  Graphics::GraphicsAPIInfo					environment,
																			  Graphics::ShaderStage						stage,
