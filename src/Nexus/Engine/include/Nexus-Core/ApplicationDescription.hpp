...
namespace Nexus
{
    ...
    {
        /// @brief The graphics configuration to use when creating a GraphicsAPI and
        /// GraphicsDevice
        ...
        /// @brief Whether to create a default graphics queue using a queue with all
        /// available capabilities
        bool CreateDefaultGraphicsQueue = true;

        /// @brief Controls how the application will call Render(), Update() and
        /// Tick(), if true they will only be called following user input
        bool EventDriven = false;

        /// @brief The organization associated with the application, used for
        /// selecting a storage location
        std::string Organization = "Nexus";

        /// @brief The name associated with the application, used for selecting a
        /// storage location
