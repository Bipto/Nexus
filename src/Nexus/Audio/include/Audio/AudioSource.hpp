...
namespace Nexus::Audio
{
	...
	class NX_AUDIO_API AudioSource
	{
	  public:
		...
		virtual void SetStaticSourceBuffer(std::shared_ptr<AudioBuffer> buffer) = 0;
		virtual void QueueBuffer(std::shared_ptr<AudioBuffer> buffer)			= 0;
		virtual void UnqueueBuffer(std::shared_ptr<AudioBuffer> buffer)			= 0;
		...
		virtual std::shared_ptr<AudioBuffer>	GetStaticSourceBuffer() const		 = 0;
