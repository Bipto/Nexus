...
namespace Nexus
{
    ...
    enum class Severity
    {
        ...
        /// @brief The message contains a potential problem that may reduce performance or cause crashes
        Warning,

        /// @brief The message contains an fatal issue with the application that will result in a crash
        Error
    };
