...
namespace Nexus::Graphics
{
    ...
    private:
        ...
        /// @brief A private method to initialise ImGui for DirectX12
        ...
        /// @brief A private method to contain all functionality for ending a frame with DirectX12
        void EndFrameImplD3D12();
