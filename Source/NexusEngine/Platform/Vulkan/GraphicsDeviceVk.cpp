...
namespace Nexus::Graphics
{
    ...
    void GraphicsDeviceVk::BeginFrame()
    {
        ...
        std::vector<VkClearAttachment> attachments(2);
        attachments[0].colorAttachment = 0;
        attachments[0].aspectMask = VK_IMAGE_ASPECT_COLOR_BIT;
        attachments[0].clearValue = clear_value;

        attachments[1].colorAttachment = 1;
        attachments[1].aspectMask = VK_IMAGE_ASPECT_DEPTH_BIT;
        attachments[1].clearValue = clear_value;

        std::vector<VkClearRect> rects(2);
        ...
        vkCmdClearAttachments(m_CurrentCommandBuffer, (uint32_t)attachments.size(), attachments.data(), (uint32_t)rects.size(), rects.data()); */
        ...
        // clear color target
        {
            ...
            vkCmdClearColorImage(
                ...
                m_SwapchainImages[m_CurrentFrameIndex],
    ...
    void GraphicsDeviceVk::CreateDepthStencil()
    {
        ...
        CreateImage(m_SwapchainSize.width, m_SwapchainSize.height, VK_FORMAT_D32_SFLOAT_S8_UINT, VK_IMAGE_TILING_OPTIMAL, VK_IMAGE_USAGE_DEPTH_STENCIL_ATTACHMENT_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, m_DepthImage, m_DepthImageMemory);
    ...
    {
        VkResult result = vkAcquireNextImageKHR(m_Device, m_Swapchain, UINT64_MAX, GetCurrentFrame().PresentSemaphore, VK_NULL_HANDLE, &m_CurrentFrameIndex);
        ...
        image = m_SwapchainImages[m_CurrentFrameIndex];
    ...
    void GraphicsDeviceVk::BeginRenderPass(VkClearColorValue clear_color, VkClearDepthStencilValue clear_depth_stencil)
    {
        ...
        render_pass_info.framebuffer = m_SwapchainFramebuffers[m_CurrentFrameIndex];
