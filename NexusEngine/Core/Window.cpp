        ...
        while (SDL_PollEvent(&event))
        {
            ...
            switch (event.type)
            {
                ...
                case SDL_KEYDOWN:
                    ...
                    break;
                case SDL_KEYUP:
                    m_Input->SetKeyState(SDLToNexusKeycode(event.key.keysym.sym), false);
                    break;
                case SDL_MOUSEBUTTONDOWN:
                    switch (event.button.button)
                    {
                        case SDL_BUTTON_LEFT:
                            m_Input->SetLeftMouseState(Nexus::MouseButtonState::Pressed);
                            break;
                        case SDL_BUTTON_RIGHT:
                            m_Input->SetRightMouseState(Nexus::MouseButtonState::Pressed);
                            break;
                    }
                    break;
                case SDL_MOUSEBUTTONUP:
                    ...
                    {
                        case SDL_BUTTON_LEFT:
                            m_Input->SetLeftMouseState(Nexus::MouseButtonState::Released);
                            break;
                        case SDL_BUTTON_RIGHT:
                            m_Input->SetRightMouseState(Nexus::MouseButtonState::Released);
                            break;
                    }
                    break;
                case SDL_MOUSEMOTION:
                    {
                        ...
                        m_Input->SetMousePosX(mouseX);
                        m_Input->SetMousePosY(mouseY);
                    }
